...
#+begin_src emacs-lisp :tangle yes
(setq doom-font (font-spec :family "Droid Sans Mono Slashed" :size 16 :weight 'medium)
      doom-big-font (font-spec :family "Droid Sans Mono Slashed" :size 22 :weight 'normal)
      doom-variable-pitch-font (font-spec :family "Droid Sans Mono Slashed" :size 16 :weight 'normal))
#+end_src
