...
#+begin_src emacs-lisp :tangle yes
(setq doom-font (font-spec :family "SF Mono" :size 16 :weight 'medium)
      doom-big-font (font-spec :family "SF Mono" :size 22 :weight 'medium)
...
Set initial frame full-height at the left edge of the monitor.
