...
#s(hash-table size 97 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2021-07-21 14:32:38" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2021-07-21 14:32:40" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2021-07-21 14:32:40" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2021-07-21 14:32:40" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2021-07-21 14:32:40" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2021-07-21 14:32:40" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "use-package" ("2021-07-21 14:32:40" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2021-07-21 14:32:40" nil (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "use-package-ensure-system-package" ("2021-07-21 14:32:40" ("use-package" "system-packages") (:flavor melpa :files ("use-package-ensure-system-package.el" "use-package-ensure-system-package-pkg.el") :package "use-package-ensure-system-package" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "system-packages" ("2021-07-21 14:32:40" ("emacs") (:type git :flavor melpa :host gitlab :repo "jabranham/system-packages" :package "system-packages" :local-repo "system-packages")) "use-package-chords" ("2021-07-21 14:32:40" ("use-package" "bind-key" "bind-chord" "key-chord") (:flavor melpa :files ("use-package-chords.el" "use-package-chords-pkg.el") :package "use-package-chords" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "bind-chord" ("2021-07-21 14:32:40" ("bind-key" "key-chord") (:flavor melpa :files ("bind-chord.el" "bind-chord-pkg.el") :package "bind-chord" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "key-chord" ("2021-07-21 14:32:40" ("emacs") (:type git :flavor melpa :host github :repo "emacsorphanage/key-chord" :package "key-chord" :local-repo "key-chord")) "exec-path-from-shell" ("2021-07-21 14:32:40" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "purcell/exec-path-from-shell" :package "exec-path-from-shell" :local-repo "exec-path-from-shell")) "hc-zenburn-theme" ("2021-07-21 14:32:41" nil (:type git :flavor melpa :files ("hc-zenburn-theme.el" "hc-zenburn-theme-pkg.el") :host github :repo "edran/hc-zenburn-emacs" :package "hc-zenburn-theme" :local-repo "hc-zenburn-emacs")) "modus-themes" ("2021-07-21 14:32:41" ("emacs") (:host gitlab :repo "protesilaos/modus-themes" :branch "main" :flavor melpa :package "modus-themes" :type git :local-repo "modus-themes")) "general" ("2021-07-21 14:32:41" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "noctuid/general.el" :package "general" :local-repo "general.el")) "flycheck" ("2021-07-21 14:32:41" ("dash" "pkg-info" "let-alist" "seq" "emacs") (:type git :flavor melpa :host github :repo "flycheck/flycheck" :package "flycheck" :local-repo "flycheck")) "dash" ("2021-07-21 14:32:41" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "pkg-info" ("2021-07-21 14:32:41" ("epl") (:type git :flavor melpa :host github :repo "emacsorphanage/pkg-info" :package "pkg-info" :local-repo "pkg-info")) "epl" ("2021-07-21 14:32:41" ("cl-lib") (:type git :flavor melpa :host github :repo "cask/epl" :package "epl" :local-repo "epl")) "let-alist" ("2021-07-21 14:32:41" ("emacs") (:type git :host github :repo "emacs-straight/let-alist" :files ("*" (:exclude ".git")) :package "let-alist" :local-repo "let-alist")) "selectrum" ("2021-07-21 14:32:41" ("emacs") (:type git :flavor melpa :host github :repo "raxod502/selectrum" :package "selectrum" :local-repo "selectrum")) "prescient" ("2021-07-21 14:32:41" ("emacs") (:type git :flavor melpa :files ("prescient.el" "prescient-pkg.el") :host github :repo "raxod502/prescient.el" :package "prescient" :local-repo "prescient.el")) "selectrum-prescient" ("2021-07-21 14:32:41" ("emacs" "prescient" "selectrum") (:flavor melpa :files ("selectrum-prescient.el" "selectrum-prescient-pkg.el") :package "selectrum-prescient" :local-repo "prescient.el" :type git :repo "raxod502/prescient.el" :host github)) "consult" ("2021-07-21 14:32:41" ("emacs") (:host github :repo "minad/consult" :branch "main" :flavor melpa :package "consult" :type git :local-repo "consult")) "consult-selectrum" ("2021-07-21 14:32:41" nil (:host github :repo "minad/consult" :branch "main" :package "consult-selectrum" :type git :local-repo "consult")) "marginalia" ("2021-07-21 14:32:41" ("emacs") (:type git :flavor melpa :host github :repo "minad/marginalia" :package "marginalia" :local-repo "marginalia")) "embark" ("2021-07-21 14:32:41" ("emacs") (:host github :repo "oantolin/embark" :branch "master" :files ("embark.el" "embark.texi" "embark-pkg.el") :flavor melpa :package "embark" :type git :local-repo "embark")) "embark-consult" ("2021-07-21 14:32:41" ("emacs" "embark" "consult") (:flavor melpa :files ("embark-consult.el" "embark-consult-pkg.el") :package "embark-consult" :local-repo "embark" :type git :repo "oantolin/embark" :host github :branch "master")) "avy" ("2021-07-21 14:32:41" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "ace-window" ("2021-07-21 14:32:41" ("avy") (:type git :flavor melpa :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "shrink-whitespace" ("2021-07-21 14:32:41" nil (:type git :flavor melpa :host gitlab :repo "jcpetkovich/shrink-whitespace.el" :package "shrink-whitespace" :local-repo "shrink-whitespace.el")) "company" ("2021-07-21 14:32:41" ("emacs") (:type git :flavor melpa :files (:defaults "icons" "company-pkg.el") :host github :repo "company-mode/company-mode" :package "company" :local-repo "company-mode")) "expand-region" ("2021-07-21 14:32:42" nil (:type git :flavor melpa :host github :repo "magnars/expand-region.el" :package "expand-region" :local-repo "expand-region.el")) "smex" ("2021-07-21 14:32:42" ("emacs") (:type git :flavor melpa :host github :repo "nonsequitur/smex" :package "smex" :local-repo "smex")) "magit" ("2021-07-21 14:32:42" ("emacs" "dash" "git-commit" "magit-section" "transient" "with-editor") (:type git :flavor melpa :files ("lisp/magit" "lisp/magit*.el" "lisp/git-rebase.el" "Documentation/magit.texi" "Documentation/AUTHORS.md" "LICENSE" (:exclude "lisp/magit-libgit.el" "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit" :package "magit" :local-repo "magit")) "git-commit" ("2021-07-21 14:32:42" ("emacs" "dash" "transient" "with-editor") (:flavor melpa :files ("lisp/git-commit.el" "git-commit-pkg.el") :package "git-commit" :local-repo "magit" :type git :repo "magit/magit" :host github)) "transient" ("2021-07-21 14:32:42" ("emacs") (:type git :flavor melpa :files ("lisp/*.el" "docs/transient.texi" "transient-pkg.el") :host github :repo "magit/transient" :package "transient" :local-repo "transient")) "with-editor" ("2021-07-21 14:32:42" ("emacs") (:type git :flavor melpa :host github :repo "magit/with-editor" :package "with-editor" :local-repo "with-editor")) "magit-section" ("2021-07-21 14:32:42" ("emacs" "dash") (:flavor melpa :files ("lisp/magit-section.el" "Documentation/magit-section.texi" "magit-section-pkg.el") :package "magit-section" :local-repo "magit" :type git :repo "magit/magit" :host github)) "reveal-in-osx-finder" ("2021-07-21 14:32:42" nil (:type git :flavor melpa :host github :repo "kaz-yos/reveal-in-osx-finder" :package "reveal-in-osx-finder" :local-repo "reveal-in-osx-finder")) "multiple-cursors" ("2021-07-21 14:32:42" ("cl-lib") (:type git :flavor melpa :host github :repo "magnars/multiple-cursors.el" :package "multiple-cursors" :local-repo "multiple-cursors.el")) "hungry-delete" ("2021-07-21 14:32:42" nil (:type git :flavor melpa :host github :repo "nflath/hungry-delete" :package "hungry-delete" :local-repo "hungry-delete")) "smartparens" ("2021-07-21 14:32:42" ("dash" "cl-lib") (:type git :flavor melpa :host github :repo "Fuco1/smartparens" :package "smartparens" :local-repo "smartparens")) "aggressive-indent" ("2021-07-21 14:32:42" ("emacs") (:type git :flavor melpa :host github :repo "Malabarba/aggressive-indent-mode" :package "aggressive-indent" :local-repo "aggressive-indent-mode")) "undo-tree" ("2021-07-21 14:32:42" nil (:type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git")) :package "undo-tree" :local-repo "undo-tree")) "evil-nerd-commenter" ("2021-07-21 14:32:42" ("emacs") (:type git :flavor melpa :host github :repo "redguardtoo/evil-nerd-commenter" :package "evil-nerd-commenter" :local-repo "evil-nerd-commenter")) "which-key" ("2021-07-21 14:32:42" ("emacs") (:type git :flavor melpa :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "wgrep" ("2021-07-21 14:32:42" nil (:type git :flavor melpa :files ("wgrep.el" "wgrep-pkg.el") :host github :repo "mhayashi1120/Emacs-wgrep" :package "wgrep" :local-repo "Emacs-wgrep")) "yasnippet" ("2021-07-21 14:32:42" ("cl-lib") (:type git :flavor melpa :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet" :package "yasnippet" :local-repo "yasnippet")) "wc-mode" ("2021-07-21 14:32:42" ("emacs") (:type git :flavor melpa :host github :repo "bnbeckwith/wc-mode" :package "wc-mode" :local-repo "wc-mode")) "company-prescient" ("2021-07-21 14:32:42" ("emacs" "prescient" "company") (:flavor melpa :files ("company-prescient.el" "company-prescient-pkg.el") :package "company-prescient" :local-repo "prescient.el" :type git :repo "raxod502/prescient.el" :host github)) "crux" ("2021-07-21 14:32:42" ("seq") (:type git :flavor melpa :host github :repo "bbatsov/crux" :package "crux" :local-repo "crux")) "fish-mode" ("2021-07-21 14:32:43" ("emacs") (:type git :flavor melpa :host github :repo "wwwjfy/emacs-fish" :package "fish-mode" :local-repo "emacs-fish")) "olivetti" ("2021-07-21 14:32:43" ("emacs") (:type git :flavor melpa :host github :repo "rnkn/olivetti" :package "olivetti" :local-repo "olivetti")) "dired+" ("2021-07-21 14:32:43" nil (:type git :host github :repo "emacsmirror/dired-plus" :package "dired+" :local-repo "dired-plus")) "org" ("2021-07-21 14:32:43" ("emacs") (:type git :repo "https://code.orgmode.org/bzg/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*")) :package "org")) "org-contrib" ("2021-07-21 14:32:44" ("emacs" "org") (:host nil :repo "https://git.sr.ht/~bzg/org-contrib" :files (:defaults "lisp/*.el") :package "org-contrib" :type git :local-repo "org-contrib")) "org-ref" ("2021-07-21 14:32:44" ("dash" "htmlize" "helm" "helm-bibtex" "ivy" "hydra" "key-chord" "s" "f" "pdf-tools" "bibtex-completion") (:type git :flavor melpa :files (:defaults "org-ref.org" "org-ref.bib" "citeproc" "org-ref-pkg.el") :host github :repo "jkitchin/org-ref" :package "org-ref" :local-repo "org-ref")) "htmlize" ("2021-07-21 14:32:44" nil (:type git :flavor melpa :host github :repo "hniksic/emacs-htmlize" :package "htmlize" :local-repo "emacs-htmlize")) "helm" ("2021-07-21 14:32:44" ("emacs" "async" "popup" "helm-core") (:type git :flavor melpa :files ("*.el" "emacs-helm.sh" (:exclude "helm.el" "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core-pkg.el") "helm-pkg.el") :host github :repo "emacs-helm/helm" :package "helm" :local-repo "helm")) "async" ("2021-07-21 14:32:44" ("emacs") (:type git :flavor melpa :host github :repo "jwiegley/emacs-async" :package "async" :local-repo "emacs-async")) "popup" ("2021-07-21 14:32:44" ("emacs") (:type git :flavor melpa :files ("popup.el" "popup-pkg.el") :host github :repo "auto-complete/popup-el" :package "popup" :local-repo "popup-el")) "helm-core" ("2021-07-21 14:32:44" ("emacs" "async") (:flavor melpa :files ("helm-core-pkg.el" "helm.el" "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core-pkg.el") :package "helm-core" :local-repo "helm" :type git :repo "emacs-helm/helm" :host github)) "helm-bibtex" ("2021-07-21 14:32:44" ("bibtex-completion" "helm" "cl-lib" "emacs") (:type git :flavor melpa :files ("helm-bibtex.el" "helm-bibtex-pkg.el") :host github :repo "tmalsburg/helm-bibtex" :package "helm-bibtex" :local-repo "helm-bibtex")) "bibtex-completion" ("2021-07-21 14:32:44" ("parsebib" "s" "dash" "f" "cl-lib" "biblio" "emacs") (:flavor melpa :files ("bibtex-completion.el" "bibtex-completion-pkg.el") :package "bibtex-completion" :local-repo "helm-bibtex" :type git :repo "tmalsburg/helm-bibtex" :host github)) "parsebib" ("2021-07-21 14:32:44" ("emacs") (:type git :flavor melpa :host github :repo "joostkremers/parsebib" :package "parsebib" :local-repo "parsebib")) "s" ("2021-07-21 14:32:44" nil (:type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "f" ("2021-07-21 14:32:44" ("s" "dash") (:type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "biblio" ("2021-07-21 14:32:44" ("emacs" "biblio-core") (:type git :flavor melpa :files (:defaults (:exclude "biblio-core.el") "biblio-pkg.el") :host github :repo "cpitclaudel/biblio.el" :package "biblio" :local-repo "biblio.el")) "biblio-core" ("2021-07-21 14:32:44" ("emacs" "let-alist" "seq" "dash") (:flavor melpa :files ("biblio-core.el" "biblio-core-pkg.el") :package "biblio-core" :local-repo "biblio.el" :type git :repo "cpitclaudel/biblio.el" :host github)) "ivy" ("2021-07-21 14:32:44" ("emacs") (:type git :flavor melpa :files (:defaults (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "doc/ivy-help.org" "ivy-pkg.el") :host github :repo "abo-abo/swiper" :package "ivy" :local-repo "swiper")) "hydra" ("2021-07-21 14:32:44" ("cl-lib" "lv") (:type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra" :package "hydra" :local-repo "hydra")) "lv" ("2021-07-21 14:32:44" nil (:flavor melpa :files ("lv.el" "lv-pkg.el") :package "lv" :local-repo "hydra" :type git :repo "abo-abo/hydra" :host github)) "pdf-tools" ("2021-07-21 14:32:44" ("emacs" "tablist" "let-alist") (:type git :flavor melpa :files ("lisp/*.el" "README" ("build" "Makefile") ("build" "server") (:exclude "lisp/tablist.el" "lisp/tablist-filter.el") "pdf-tools-pkg.el") :host github :repo "vedang/pdf-tools" :package "pdf-tools" :local-repo "pdf-tools")) "tablist" ("2021-07-21 14:32:44" ("emacs") (:type git :flavor melpa :host github :repo "politza/tablist" :package "tablist" :local-repo "tablist")) "orgonomic" ("2021-07-21 14:32:47" nil (:host github :repo "aaronjensen/emacs-orgonomic" :package "orgonomic" :type git :local-repo "emacs-orgonomic")) "org-journal" ("2021-07-21 07:57:18" ("emacs" "org") (:type git :flavor melpa :host github :repo "bastibe/org-journal" :package "org-journal" :local-repo "org-journal")) "deft" ("2021-07-21 14:32:47" nil (:type git :flavor melpa :host github :repo "jrblevin/deft" :package "deft" :local-repo "deft")) "org-roam" ("2021-07-21 14:32:47" ("emacs" "dash" "f" "org" "emacsql" "emacsql-sqlite" "magit-section") (:type git :flavor melpa :host github :repo "org-roam/org-roam" :package "org-roam" :local-repo "org-roam")) "emacsql" ("2021-07-21 14:32:47" ("emacs") (:type git :flavor melpa :files ("emacsql.el" "emacsql-compiler.el" "emacsql-system.el" "README.md" "emacsql-pkg.el") :host github :repo "skeeto/emacsql" :package "emacsql" :local-repo "emacsql")) "emacsql-sqlite" ("2021-07-21 14:32:47" ("emacs" "emacsql") (:flavor melpa :files ("emacsql-sqlite.el" "sqlite" "emacsql-sqlite-pkg.el") :package "emacsql-sqlite" :local-repo "emacsql" :type git :repo "skeeto/emacsql" :host github)) "markdown-mode" ("2021-07-21 14:32:47" ("emacs") (:type git :flavor melpa :host github :repo "jrblevin/markdown-mode" :package "markdown-mode" :local-repo "markdown-mode")) "auctex" ("2021-07-21 14:32:47" ("emacs") (:type git :host github :repo "emacs-straight/auctex" :files ("*" (:exclude ".git")) :package "auctex" :local-repo "auctex")) "auctex-latexmk" ("2021-07-21 14:32:47" ("auctex") (:type git :flavor melpa :host github :repo "tom-tan/auctex-latexmk" :package "auctex-latexmk" :local-repo "auctex-latexmk")) "cdlatex" ("2021-07-21 14:32:48" nil (:type git :flavor melpa :host github :repo "cdominik/cdlatex" :package "cdlatex" :local-repo "cdlatex")) "bibtex-actions" ("2021-07-21 14:32:48" ("emacs" "bibtex-completion") (:host github :repo "bdarcus/bibtex-actions" :flavor melpa :package "bibtex-actions" :type git :local-repo "bibtex-actions")) "ebib" ("2021-07-21 14:32:48" ("parsebib" "emacs") (:type git :flavor melpa :host github :repo "joostkremers/ebib" :package "ebib" :local-repo "ebib")) "web-mode" ("2021-07-21 14:32:48" ("emacs") (:type git :flavor melpa :host github :repo "fxbois/web-mode" :package "web-mode" :local-repo "web-mode")) "emmet-mode" ("2021-07-21 14:32:49" nil (:type git :flavor melpa :host github :repo "smihica/emmet-mode" :package "emmet-mode" :local-repo "emmet-mode")) "company-web" ("2021-07-21 14:32:49" ("company" "dash" "cl-lib" "web-completion-data") (:type git :flavor melpa :host github :repo "osv/company-web" :package "company-web" :local-repo "company-web")) "web-completion-data" ("2021-07-21 14:32:49" nil (:type git :flavor melpa :files ("*.el" "html-stuff" "web-completion-data-pkg.el") :host github :repo "osv/web-completion-data" :package "web-completion-data" :local-repo "web-completion-data")) "major-mode-hydra" ("2021-07-21 14:32:49" ("dash" "pretty-hydra" "emacs") (:type git :flavor melpa :files ("major-mode-hydra.el" "major-mode-hydra-pkg.el") :host github :repo "jerrypnz/major-mode-hydra.el" :package "major-mode-hydra" :local-repo "major-mode-hydra.el")) "pretty-hydra" ("2021-07-21 14:32:49" ("hydra" "s" "dash" "emacs") (:flavor melpa :files ("pretty-hydra.el" "pretty-hydra-pkg.el") :package "pretty-hydra" :local-repo "major-mode-hydra.el" :type git :repo "jerrypnz/major-mode-hydra.el" :host github)) "diminish" ("2021-07-21 14:32:49" ("emacs") (:type git :flavor melpa :host github :repo "myrjola/diminish.el" :package "diminish" :local-repo "diminish.el")) "ox-hugo" ("2021-07-21 14:32:49" ("emacs" "org") (:type git :flavor melpa :host github :repo "kaushalmodi/ox-hugo" :package "ox-hugo" :local-repo "ox-hugo"))))
...
with the specified `:load-path' the module cannot be found." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "use-package-lint" '("use-package-lint-declaration"))) (provide 'use-package-autoloads)) "system-packages" ((system-packages-autoloads system-packages) (autoload 'system-packages-install "system-packages" "Install system packages.
...
(fn NAME KEYWORD ARG REST STATE)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "use-package-ensure-system-package" '("use-package-ensure-system-package-"))) (provide 'use-package-ensure-system-package-autoloads)) "key-chord" ((key-chord-autoloads key-chord) (defvar key-chord-mode nil "Non-nil if Key-Chord mode is enabled.
...
(fn KEYMAP KEYS COMMAND)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "key-chord" '("key-chord-"))) (provide 'key-chord-autoloads)) "bind-chord" ((bind-chord bind-chord-autoloads) (autoload 'bind-chord "bind-chord" "Bind CHORD to COMMAND in KEYMAP (`global-map' if not passed).
...
values used in the user's shell." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "exec-path-from-shell" '("exec-path-from-shell-"))) (provide 'exec-path-from-shell-autoloads)) "hc-zenburn-theme" ((hc-zenburn-theme-autoloads hc-zenburn-theme) (and load-file-name (boundp 'custom-theme-load-path) (add-to-list 'custom-theme-load-path (file-name-as-directory (file-name-directory load-file-name)))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "hc-zenburn-theme" '("hc-zenburn"))) (provide 'hc-zenburn-theme-autoloads)) "modus-themes" ((modus-themes modus-vivendi-theme modus-operandi-theme modus-themes-autoloads) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "modus-operandi-theme" '("modus-operandi"))) (autoload 'modus-themes-contrast "modus-themes" "Measure WCAG contrast ratio between C1 and C2.
...
(fn &optional SHORT-NAMES _)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "general" '("general-"))) (provide 'general-autoloads)) "dash" ((dash dash-autoloads) (autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
(fn FETCHER &optional ALIST)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "consult-xref" '("consult-xref--"))) (provide 'consult-autoloads)) "consult-selectrum" ((consult-org consult-selectrum-autoloads consult-selectrum consult-imenu consult-vertico consult-icomplete consult-compile consult-flymake consult-xref consult-register consult) (autoload 'consult-completion-in-region "consult" "Use minibuffer completion as the UI for `completion-at-point'.
...
(fn FETCHER &optional ALIST)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "consult-xref" '("consult-xref--"))) (provide 'consult-selectrum-autoloads)) "marginalia" ((marginalia marginalia-autoloads) (defvar marginalia-mode nil "Non-nil if Marginalia mode is enabled.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ace-window" '("ace-window-mode" "aw-"))) (provide 'ace-window-autoloads)) "shrink-whitespace" ((shrink-whitespace shrink-whitespace-autoloads) (autoload 'shrink-whitespace "shrink-whitespace" "Remove whitespace around cursor to just one or none.
...
(fn ARG)" t nil) (autoload 'shrink-whitespace-grow-whitespace-around "shrink-whitespace" "Counterpart to 'shrink-whitespace', grow whitespace in a smartish way." t nil) (autoload 'shrink-whitespace-shrink-whitespace-around "shrink-whitespace" "Shrink whitespace surrounding point." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "shrink-whitespace" '("grow-whitespace-around" "shrink-whitespace-"))) (provide 'shrink-whitespace-autoloads)) "company" ((company-dabbrev-code company-tempo company-gtags company-elisp company-autoloads company-etags company-ispell company-capf company-yasnippet company-template company-nxml company-css company-clang company company-files company-abbrev company-keywords company-cmake company-semantic company-tng company-bbdb company-oddmuse company-dabbrev) (autoload 'company-mode "company" "\"complete anything\"; is an in-buffer completion framework.
...
(fn WORKTREE PATH)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "magit-worktree" '("magit-"))) (provide 'magit-autoloads)) "reveal-in-osx-finder" ((reveal-in-osx-finder-autoloads reveal-in-osx-finder) (autoload 'reveal-in-osx-finder "reveal-in-osx-finder" "Reveal the file associated with the current buffer in the OS X Finder.
In a dired buffer, it will open the current directory." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "reveal-in-osx-finder" '("reveal-in-osx-finder-as"))) (provide 'reveal-in-osx-finder-autoloads)) "multiple-cursors" ((multiple-cursors-autoloads mc-edit-lines mc-mark-pop mc-cycle-cursors multiple-cursors-core mc-separate-operations multiple-cursors mc-mark-more multiple-cursors-pkg rectangular-region-mode mc-hide-unmatched-lines-mode) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mc-cycle-cursors" '("mc/"))) (autoload 'mc/edit-lines "mc-edit-lines" "Add one cursor to each line of the active region.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rectangular-region-mode" '("rectangular-region-mode" "rrm/"))) (provide 'multiple-cursors-autoloads)) "hungry-delete" ((hungry-delete-autoloads hungry-delete) (autoload 'hungry-delete-forward "hungry-delete" "Delete the following character, or all of the following
...
(fn N &optional KILLFLAG)" t nil) (autoload 'hungry-delete-backward "hungry-delete" "Delete the preceding character or all preceding whitespace
...
(fn N &optional KILLFLAG)" t nil) (autoload 'hungry-delete-mode "hungry-delete" "Minor mode to enable hungry deletion.  This will delete all
...
(fn &optional ARG)" t nil) (autoload 'turn-on-hungry-delete-mode "hungry-delete" "Turn on hungry delete mode if the buffer is appropriate." t nil) (put 'global-hungry-delete-mode 'globalized-minor-mode t) (defvar global-hungry-delete-mode nil "Non-nil if Global Hungry-Delete mode is enabled.
See the `global-hungry-delete-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `global-hungry-delete-mode'.") (custom-autoload 'global-hungry-delete-mode "hungry-delete" nil) (autoload 'global-hungry-delete-mode "hungry-delete" "Toggle Hungry-Delete mode in all buffers.
...
(fn L R)" t nil) (autoload 'aggressive-indent-mode "aggressive-indent" "Toggle Aggressive-Indent mode on or off.
...
(fn &optional ARG)" t nil) (defalias 'aggressive-indent-global-mode #'global-aggressive-indent-mode) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "aggressive-indent" '("aggressive-indent-"))) (provide 'aggressive-indent-autoloads)) "undo-tree" ((undo-tree undo-tree-autoloads) (autoload 'undo-tree-mode "undo-tree" "Toggle undo-tree mode.
...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "which-key" '("evil-state" "which-key-"))) (provide 'which-key-autoloads)) "wgrep" ((wgrep wgrep-autoloads) (autoload 'wgrep-setup "wgrep" "Setup wgrep preparation." nil nil) (add-hook 'grep-setup-hook 'wgrep-setup) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "wgrep" '("wgrep-"))) (provide 'wgrep-autoloads)) "yasnippet" ((yasnippet yasnippet-autoloads) (autoload 'yas-minor-mode "yasnippet" "Toggle YASnippet mode.
...
(fn &optional ARG)" t nil) (autoload 'snippet-mode "yasnippet" "A mode for editing yasnippets" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "yasnippet" '("help-snippet-def" "snippet-mode-map" "yas"))) (provide 'yasnippet-autoloads)) "wc-mode" ((wc-mode wc-mode-autoloads) (autoload 'wc-mode "wc-mode" "Toggle wc mode With no argument, this command toggles the
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "wc-mode" 'nil)) (provide 'wc-mode-autoloads)) "company-prescient" ((company-prescient-autoloads company-prescient) (defvar company-prescient-mode nil "Non-nil if Company-Prescient mode is enabled.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "company-prescient" '("company-prescient-"))) (provide 'company-prescient-autoloads)) "crux" ((crux crux-autoloads) (autoload 'crux-open-with "crux" "Open visited file in default external program.
...
(fn P)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "crux" '("crux-"))) (provide 'crux-autoloads)) "fish-mode" ((fish-mode fish-mode-autoloads) (autoload 'fish_indent-before-save "fish-mode" nil t nil) (autoload 'fish-mode "fish-mode" "Major mode for editing fish shell files.

(fn)" t nil) (add-to-list 'auto-mode-alist '("\\.fish\\'" . fish-mode)) (add-to-list 'auto-mode-alist '("/fish_funced\\..*\\'" . fish-mode)) (add-to-list 'interpreter-mode-alist '("fish" . fish-mode)) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "fish-mode" '("fish"))) (provide 'fish-mode-autoloads)) "olivetti" ((olivetti olivetti-autoloads) (autoload 'olivetti-mode "olivetti" "Olivetti provides a nice writing environment.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "olivetti" '("olivetti-"))) (provide 'olivetti-autoloads)) "dired+" ((dired+-autoloads dired+) (defvar diff-switches "-c" "*A string or list of strings specifying switches to be passed to diff.") (custom-autoload 'diff-switches "dired+" t) (defvar diredp-auto-focus-frame-for-thumbnail-tooltip-flag nil "*Non-nil means automatically focus the frame for a thumbnail tooltip.
...
`highlight.el'." :set (lambda (symbol value) (diredp-highlight-autofiles-mode (if value 1 -1))) :initialize 'custom-initialize-default :type 'boolean :group 'Dired-Plus :require 'dired+)) (defvar diredp-ignore-compressed-flag t "*Non-nil means to font-lock names of compressed files as ignored files.
...
the circumstances in which they show the files in separate frames.") (custom-autoload 'diredp-max-frames "dired+" t) (defvar diredp-omit-lines-regexp nil "Regexp matching lines to be omitted by `dired-omit-mode'.
 ...
 * Function: Pass `dired-actual-switches' as arg and show result.") (custom-autoload 'diredp-switches-in-mode-line "dired+" t) (defvar diredp-visit-ignore-extensions '("elc") "Extensions of file names for `diredp-visit-(next|previous)' to skip.
...
name and DESCRIPTION describes DRIVE.") (custom-autoload 'diredp-w32-local-drives "dired+" t) (defvar diredp-wrap-around-flag t "*Non-nil means Dired \"next\" commands wrap around to buffer beginning.") (custom-autoload 'diredp-wrap-around-flag "dired+" t) (autoload 'diredp-image-dired-create-thumb "dired+" "Create thumbnail image file for FILE (default: file on current line).
...
(fn FILE &optional ARG)" t nil) (autoload 'image-dired-dired-insert-marked-thumbs "dired+" "Insert thumbnails before file names of marked files in the Dired buffer." t nil) (autoload 'image-dired-dired-toggle-marked-thumbs "dired+" "Toggle thumbnails in front of file names in Dired.
...
(fn &optional ARG)" t nil) (autoload 'diredp-image-dired-comment-file "dired+" "Add comment to this image file." t nil) (autoload 'diredp-image-dired-tag-file "dired+" "Tag this image file with an `image-dired' tag." t nil) (autoload 'diredp-image-dired-delete-tag "dired+" "Remove an `image-dired' tag from  this image file." t nil) (autoload 'diredp-image-dired-display-thumb "dired+" "Pop to thumbnail of this image file, in `image-dired-thumbnail-buffer'.
...
(fn &optional APPEND)" t nil) (autoload 'diredp-image-dired-copy-with-exif-name "dired+" "Copy this image file to your main image directory.
Uses `image-dired-get-exif-file-name' to name the new file." t nil) (autoload 'diredp-image-dired-edit-comment-and-tags "dired+" "Edit comment and tags for this image file." t nil) (autoload 'diredp-do-display-images "dired+" "Display the marked image files.
...
(fn &optional ARG)" t nil) (autoload 'diredp-image-show-this-file "dired+" "Show the image file named on this line in another frame or window.
...
(fn &optional ARG)" t nil) (autoload 'diredp-dired-for-files "dired+" "Dired the file names that you enter, in a Dired buffer that you name.
...
(fn ARG &optional SWITCHES)" t nil) (autoload 'diredp-dired-for-files-other-window "dired+" "Same as `diredp-dired-for-files', except uses another window.

(fn ARG &optional SWITCHES)" t nil) (autoload 'diredp-dired-recent-files "dired+" "Open Dired in BUFFER, showing recently visited files and directories.
...
(fn BUFFER &optional ARG FILES)" t nil) (autoload 'diredp-dired-recent-files-other-window "dired+" "Same as `diredp-dired-recent-files', but use other window.

(fn BUFFER &optional ARG FILES)" t nil) (autoload 'diredp-dired-recent-dirs "dired+" "Open Dired in BUFFER, showing recently visited directories.
Like `diredp-dired-recent-files', but limited to recent directories.
A directory is recent if any of its files is recent.

(fn BUFFER &optional ARG FILES)" t nil) (autoload 'diredp-dired-recent-dirs-other-window "dired+" "Same as `diredp-dired-recent-dirs', but use other window.

(fn BUFFER &optional ARG FILES)" t nil) (autoload 'diredp-do-add-to-recentf "dired+" "Add all marked (or next ARG) files to list of recently used files.
...
(fn &optional ARG)" t nil) (autoload 'diredp-do-remove-from-recentf "dired+" "Remove all marked (or next ARG) files from list of recently used files.
That is, remove them from variable `recentf-list'.

(This does not refresh any Dired buffer listing the recently visited
files.  You can refresh it manually using `\\[revert-buffer]'.

(fn &optional ARG)" t nil) (autoload 'diredp-add-this-to-recentf "dired+" "In Dired, add this file to the list of recently used files." t nil) (autoload 'diredp-remove-this-from-recentf "dired+" "In Dired, remove this file from the list of recently used files." t nil) (autoload 'diredp-add-file-to-recentf "dired+" "Add FILE to the front of `recentf-list'.
If FILE is already present, move it to the front of the list.
In Dired, FILE defaults to the file of the current Dired line.

(fn &optional FILE INTERACTIVEP)" t nil) (autoload 'diredp-remove-file-from-recentf "dired+" "Remove FILE from `recentf-list'.
In Dired, FILE defaults to the file of the current Dired line.

Interactively: After removing, revert any displayed buffers showing
`recentf-list' (or part of it).

(fn &optional FILE INTERACTIVEP)" t nil) (autoload 'diredp-sort-arbitrary-command "dired+" "Sort the current Dired listing of arbitary files.
...
(fn SORT-FUNCTION)" t nil) (autoload 'diredp-dired-union "dired+" "Create a Dired buffer that is the union of some existing Dired buffers.
...
(fn DIRED-NAME DIRBUFS &optional SWITCHES EXTRA)" t nil) (autoload 'diredp-dired-union-other-window "dired+" "Same as `diredp-dired-union', except use other window.

(fn DIRED-NAME DIRBUFS &optional SWITCHES EXTRA)" t nil) (autoload 'diredp-add-to-dired-buffer "dired+" "Add individual file and directory names to a Dired buffer.
...
(fn DIRED-NAME TO-ADD &optional SWITCHES)" t nil) (autoload 'diredp-add-to-dired-buffer-other-window "dired+" "Same as `diredp-add-to-dired-buffer', except use other window.

(fn DIRED-NAME TO-ADD &optional SWITCHES)" t nil) (autoload 'diredp-add-to-this-dired-buffer "dired+" "Same as `diredp-add-to-dired-buffer' for this Dired buffer.

(fn DIRED-NAME TO-ADD &optional SWITCHES)" t nil) (autoload 'diredp-fileset "dired+" "Open Dired on the files in fileset FLSET-NAME.

(fn FLSET-NAME)" t nil) (autoload 'diredp-fileset-other-window "dired+" "Open Dired in another window on the files in fileset FLSET-NAME.

(fn FLSET-NAME)" t nil) (autoload 'diredp-dired-this-subdir "dired+" "Open Dired for the subdir at or above point.
...
(fn &optional TEAR-OFF-P MSGP)" t nil) (autoload 'diredp-dired-inserted-subdirs "dired+" "Open Dired for each of the subdirs inserted in this Dired buffer.
...
(fn &optional NO-SHOW-P MSGP)" t nil) (autoload 'diredp-find-line-file-other-window "dired+" "Visit file named by current line, in another window.
The full text of the line is used as the file name." t nil) (autoload 'diredp-mouse-find-line-file-other-window "dired+" "Visit file named by clicked line, in another window.
The full text of the line is used as the file name.

(fn E)" t nil) (autoload 'diredp-list-marked "dired+" "List the marked files in this Dired buffer.
...
(fn &optional ARG PREDICATE INTERACTIVEP DETAILS)" t nil) (defalias 'diredp-paste-files 'diredp-yank-files) (autoload 'diredp-yank-files "dired+" "Yank (paste) files to the current directory.
...
(fn &optional DIR NO-CONFIRM-P DETAILS)" t nil) (autoload 'diredp-move-files-named-in-kill-ring "dired+" "Move files, whose absolute names you copied, to the current directory.
With a non-negative prefix arg you are instead prompted for the target
 directory.
With a non-positive prefix arg you can see details about the files if
 you hit `l' when prompted to confirm pasting.  Otherwise you see only
...
(fn &optional DIR NO-CONFIRM-P DETAILS)" t nil) (when (> emacs-major-version 21) (defun diredp-kill-this-tree nil "Remove this subdir listing and lower listings." (interactive) (dired-kill-tree (dired-current-directory) nil 'KILL-ROOT))) (autoload 'diredp-insert-subdirs "dired+" "Insert the marked subdirectories.
Like using \\<dired-mode-map>`\\[dired-maybe-insert-subdir]' at each marked directory line.

(fn &optional SWITCHES INTERACTIVEP)" t nil) (autoload 'diredp-insert-subdirs-recursive "dired+" "Insert the marked subdirs, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-shell-command-recursive "dired+" "Run shell COMMAND on the marked files, including those in marked subdirs.
...
(fn COMMAND &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-symlink-recursive "dired+" "Make symbolic links to marked files, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-hardlink-recursive "dired+" "Add hard links for marked files, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-print-recursive "dired+" "Print the marked files, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-image-dired-display-thumbs-recursive "dired+" "Display thumbnails of marked files, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P APPEND DO-NOT-POP DETAILS)" t nil) (autoload 'diredp-image-dired-tag-files-recursive "dired+" "Tag marked files with an `image-dired' tag, including in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-image-dired-delete-tag-recursive "dired+" "Remove `image-dired' tag for marked files, including in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-image-dired-comment-files-recursive "dired+" "Add comment to marked files in dired, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-bookmark-recursive "dired+" "Bookmark the marked files, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P PREFIX DETAILS)" t nil) (autoload 'diredp-do-bookmark-dirs-recursive "dired+" "Bookmark this Dired buffer and marked subdirectory Dired buffers, recursively.
...
(fn IGNORE-MARKS-P &optional DETAILS MSGP)" t nil) (autoload 'diredp-do-bookmark-in-bookmark-file-recursive "dired+" "Bookmark files here and below in BOOKMARK-FILE and save BOOKMARK-FILE.
...
(fn BOOKMARK-FILE &optional PREFIX IGNORE-MARKS-P BFILE-BOOKMARKP DETAILS)" t nil) (autoload 'diredp-set-bookmark-file-bookmark-for-marked-recursive "dired+" "Bookmark the marked files and create a bookmark-file bookmark for them.
...
(fn BOOKMARK-FILE &optional PREFIX IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-find-marked-files-recursive "dired+" "Find marked files simultaneously, including those in marked subdirs.
...
(fn &optional ARG DETAILS)" t nil) (autoload 'diredp-do-query-replace-regexp-recursive "dired+" "Do `query-replace-regexp' on marked files, including in marked subdirs.
...
(fn FROM TO &optional ARG DETAILS)" t nil) (autoload 'diredp-do-grep-recursive "dired+" "Run `grep' on marked files, including those in marked subdirs.
...
(fn COMMAND-ARGS &optional DETAILS)" t nil) (autoload 'diredp-marked-recursive "dired+" "Open Dired on marked files, including those in marked subdirs.
...
(fn DIRNAME &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-marked-recursive-other-window "dired+" "Same as `diredp-marked-recursive', but uses a different window.

When called from Lisp, optional arg DETAILS is passed to
`diredp-get-files'.

(fn DIRNAME &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-list-marked-recursive "dired+" "List the files marked here and in marked subdirs, recursively.
The files included are those that are marked in the current Dired
buffer, or all files in the directory if none are marked.  Marked
subdirectories are handled recursively in the same way.
...
(fn &optional IGNORE-MARKS-P PREDICATE DETAILS)" t nil) (autoload 'diredp-flag-auto-save-files-recursive "dired+" "Flag all auto-save files for deletion, including in marked subdirs.
...
(fn &optional ARG DETAILS)" t nil) (autoload 'diredp-copy-filename-as-kill-recursive "dired+" "Copy names of marked files here and in marked subdirs, to `kill-ring'.
...
(fn &optional ARG DETAILS)" t nil) (autoload 'diredp-copy-abs-filenames-as-kill-recursive "dired+" "Copy absolute names of files marked here and in marked subdirs, recursively.
The names are copied to the kill ring and to variable
`diredp-last-copied-filenames'.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-mark-files-regexp-recursive "dired+" "Mark all files matching REGEXP, including those in marked subdirs.
...
(fn REGEXP &optional MARKER-CHAR IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-mark-files-containing-regexp-recursive "dired+" "Mark files with contents containing a REGEXP match, including in marked subdirs.
...
(fn REGEXP &optional MARKER-CHAR IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-mark-autofiles-recursive "dired+" "Mark all autofiles, including in marked subdirs.
...
(fn &optional ARG DETAILS)" t nil) (autoload 'diredp-mark-executables-recursive "dired+" "Mark all executable files, including in marked subdirs.
The files included are those that are marked in the current Dired
buffer, or all files in the directory if none are marked.  Marked
subdirectories are handled recursively in the same way.
...
(fn &optional ARG DETAILS)" t nil) (autoload 'diredp-mark-directories-recursive "dired+" "Mark all directories except `.' and `..', including in marked subdirs.
...
(fn &optional ARG DETAILS)" t nil) (autoload 'diredp-mark-symlinks-recursive "dired+" "Mark all symbolic links, including in marked subdirs.
...
(fn &optional ARG DETAILS)" t nil) (autoload 'diredp-capitalize-recursive "dired+" "Rename marked files, including in marked subdirs, by capitalizing them.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-upcase-recursive "dired+" "Rename marked files, including in marked subdirs, making them uppercase.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-downcase-recursive "dired+" "Rename marked files, including in marked subdirs, making them lowercase.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-aggregate-apply-to-marked-recursive "dired+" "Aggregate function applications to marked files, including in marked subdirs.
...
(fn AGGREGATE-FUN APPLY-FUN &optional IGNORE-MARKS-P DETAILS MSGP)" t nil) (autoload 'diredp-do-aggregate-eval-in-marked-recursive "dired+" "Aggregate results of invoking a function in the marked files and dirs.
This command prompts you for the aggregate function, AGGREGATE-FUN,
...
(fn AGGREGATE-FUN SEXP &optional IGNORE-MARKS-P DETAILS MSGP)" t nil) (autoload 'diredp-do-apply-to-marked-recursive "dired+" "Apply FUNCTION to names of marked files, including in marked subdirs.
...
(fn FUNCTION &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-command-in-marked-recursive "dired+" "Invoke Emacs COMMAND in each marked file, including in marked subdirs.
Like \342\200\230diredp-do-command-in-marked\342\200\231 but act recursively on subdirs.
...
When called from Lisp, optional arg DETAILS is passed to
\342\200\230diredp-get-files\342\200\231.
...
(fn COMMAND &optional ARG DETAILS)" t nil) (autoload 'diredp-do-eval-in-marked-recursive "dired+" "Evaluate SEXP in each of the marked files, including in marked subdirs.
...
(fn SEXP &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-apply/eval-marked-recursive "dired+" "Apply a function to marked files, or evaluate a sexp in them.
...
(fn FUN/SEXP &optional ARG DETAILS)" t nil) (autoload 'diredp-do-delete-recursive "dired+" "Delete marked (not flagged) files, including in marked subdirs.
...
(fn ARG &optional DETAILS)" t nil) (autoload 'diredp-do-move-recursive "dired+" "Move marked files, including in marked subdirs, to a given directory.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-copy-recursive "dired+" "Copy marked files, including in marked subdirs, to a given directory.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-chmod-recursive "dired+" "Change the mode of the marked files, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-touch-recursive "dired+" "Change the timestamp of marked files, including those in marked subdirs.
...
(fn &optional IGNORE-MARKS-P DETAILS)" t nil) (autoload 'diredp-do-redisplay-recursive "dired+" "Redisplay marked file lines, including those in marked subdirs.
...
(fn &optional DETAILS MSGP)" t nil) (autoload 'diredp-change-ls-switches "dired+" "Change `ls' switches for the current Dired buffer.
...
(fn SWITCHES)" t nil) (autoload 'diredp-marked "dired+" "Open Dired on only the marked files or the next N files.
...
(fn DIRNAME &optional N SWITCHES)" t nil) (autoload 'diredp-marked-other-window "dired+" "Same as `diredp-marked', but uses a different window.

(fn DIRNAME &optional N SWITCHES)" t nil) (autoload 'diredp-mark/unmark-extension "dired+" "Mark all files with a certain EXTENSION for use in later commands.
...
(fn EXTENSION &optional UNMARK-P)" t nil) (autoload 'diredp-mark-files-tagged-all "dired+" "Mark all files that are tagged with *each* tag in TAGS.
...
(fn TAGS &optional NONE-P PREFIX)" t nil) (autoload 'diredp-mark-files-tagged-none "dired+" "Mark all files that are not tagged with *any* tag in TAGS.
As a special case, if TAGS is empty, then mark the files that have
 no tags at all.
With a prefix arg, mark all that are tagged with *each* tag in TAGS.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional ALLP PREFIX)" t nil) (autoload 'diredp-mark-files-tagged-some "dired+" "Mark all files that are tagged with *some* tag in TAGS.
As a special case, if TAGS is empty, then mark the files that have
 any tags at all (i.e., at least one tag).
With a prefix arg, mark all that are *not* tagged with *all* TAGS.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional SOMENOTP PREFIX)" t nil) (autoload 'diredp-mark-files-tagged-not-all "dired+" "Mark all files that are not tagged with *all* TAGS.
As a special case, if TAGS is empty, then mark the files that have
 no tags at all.
With a prefix arg, mark all that are tagged with *some* TAGS.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional SOMEP PREFIX)" t nil) (autoload 'diredp-mark-files-tagged-regexp "dired+" "Mark files that have at least one tag that matches REGEXP.
With a prefix arg, mark all that are tagged but have no matching tags.
You need library `bookmark+.el' to use this command.

(fn REGEXP &optional NOTP PREFIX)" t nil) (autoload 'diredp-unmark-files-tagged-regexp "dired+" "Unmark files that have at least one tag that matches REGEXP.
With a prefix arg, unmark all that are tagged but have no matching tags.
You need library `bookmark+.el' to use this command.

(fn REGEXP &optional NOTP PREFIX)" t nil) (autoload 'diredp-unmark-files-tagged-all "dired+" "Unmark all files that are tagged with *each* tag in TAGS.
...
(fn TAGS &optional NONE-P PREFIX)" t nil) (autoload 'diredp-unmark-files-tagged-none "dired+" "Unmark all files that are *not* tagged with *any* tag in TAGS.
As a special case, if TAGS is empty, then unmark the files that have
 no tags at all.
With a prefix arg, unmark all that are tagged with *each* tag in TAGS.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional ALLP PREFIX)" t nil) (autoload 'diredp-unmark-files-tagged-some "dired+" "Unmark all files that are tagged with *some* tag in TAGS.
As a special case, if TAGS is empty, then unmark the files that have
 any tags at all.
With a prefix arg, unmark all that are *not* tagged with *all* TAGS.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional SOMENOTP PREFIX)" t nil) (autoload 'diredp-unmark-files-tagged-not-all "dired+" "Unmark all files that are *not* tagged with *all* TAGS.
As a special case, if TAGS is empty, then unmark the files that have
 no tags at all.
With a prefix arg, unmark all that are tagged with *some* TAGS.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional SOMEP PREFIX)" t nil) (autoload 'diredp-do-tag "dired+" "Tag the marked (or the next prefix argument) files.
You need library `bookmark+.el' to use this command.
...
(fn TAGS &optional PREFIX ARG)" t nil) (autoload 'diredp-mouse-do-tag "dired+" "In Dired, add some tags to this file.
Like `diredp-do-tag', but invoked using the mouse.
You need library `bookmark+.el' to use this command.

(fn EVENT)" t nil) (autoload 'diredp-do-untag "dired+" "Remove some tags from the marked (or the next prefix arg) files.
You need library `bookmark+.el' to use this command.
...
(fn TAGS &optional PREFIX ARG)" t nil) (autoload 'diredp-mouse-do-untag "dired+" "In Dired, remove some tags from this file.
Like `diredp-do-untag', but invoked using the mouse.
You need library `bookmark+.el' to use this command.

(fn EVENT)" t nil) (autoload 'diredp-do-remove-all-tags "dired+" "Remove all tags from the marked (or the next prefix arg) files.
You need library `bookmark+.el' to use this command.
...
(fn &optional PREFIX ARG)" t nil) (autoload 'diredp-mouse-do-remove-all-tags "dired+" "In Dired, remove all tags from the marked (or next prefix arg) files.
Like `diredp-do-remove-all-tags', but invoked using the mouse.
You need library `bookmark+.el' to use this command.

(fn EVENT)" t nil) (autoload 'diredp-do-paste-add-tags "dired+" "Add previously copied tags to the marked (or next prefix arg) files.
...
(fn &optional PREFIX ARG)" t nil) (autoload 'diredp-mouse-do-paste-add-tags "dired+" "In Dired, add previously copied tags to this file.
The tags were previously copied from a file to `bmkp-copied-tags'.
Like `diredp-do-paste-add-tags', but invoked using the mouse.
You need library `bookmark+.el' to use this command.

(fn EVENT)" t nil) (autoload 'diredp-do-paste-replace-tags "dired+" "Replace tags for marked (or next prefix arg) files with copied tags.
The tags were previously copied from a file to `bmkp-copied-tags'.
You need library `bookmark+.el' to use this command.
...
(fn &optional PREFIX ARG)" t nil) (autoload 'diredp-mouse-do-paste-replace-tags "dired+" "In Dired, replace tags for this file with tags copied previously.
The tags were previously copied from a file to `bmkp-copied-tags'.
Like `diredp-do-paste-replace-tags', but invoked using the mouse.
You need library `bookmark+.el' to use this command.

(fn EVENT)" t nil) (autoload 'diredp-do-set-tag-value "dired+" "Set TAG value to VALUE, for the marked (or next prefix arg) files.
...
(fn TAG VALUE &optional PREFIX ARG)" t nil) (autoload 'diredp-mouse-do-set-tag-value "dired+" "In Dired, set the value of a tag for this file.
This does not change the tag name.
Like `diredp-do-set-tag-value', but invoked using the mouse.
You need library `bookmark+.el' to use this command.

(fn EVENT)" t nil) (autoload 'diredp-mark-autofiles "dired+" "Mark all autofiles, that is, files that have an autofile bookmark." t nil) (autoload 'diredp-unmark-autofiles "dired+" "Unmark all autofiles, that is, files that have an autofile bookmark." t nil) (autoload 'diredp-mark/unmark-autofiles "dired+" "Mark all autofiles, or unmark if UNMARKP is non-nil.

(fn &optional UNMARKP)" nil nil) (autoload 'diredp-do-bookmark "dired+" "Bookmark the marked (or the next prefix argument) files.
...
(fn &optional PREFIX ARG)" t nil) (autoload 'diredp-mouse-do-bookmark "dired+" "In Dired, bookmark this file.  See `diredp-do-bookmark'.
Like `diredp-do-bookmark', but invoked using the mouse.

(fn EVENT)" t nil) (autoload 'diredp-set-bookmark-file-bookmark-for-marked "dired+" "Bookmark the marked files and create a bookmark-file bookmark for them.
The bookmarked position is the beginning of the file.
...
(fn BOOKMARK-FILE &optional PREFIX ARG)" t nil) (autoload 'diredp-do-bookmark-in-bookmark-file "dired+" "Bookmark marked files in BOOKMARK-FILE and save BOOKMARK-FILE.
...
(fn BOOKMARK-FILE &optional PREFIX ARG BFILE-BOOKMARKP FILES)" t nil) (autoload 'diredp-find-a-file "dired+" "`find-file', but use file on current line as default (`M-n').

(fn FILENAME &optional WILDCARDS)" t nil) (autoload 'diredp-find-a-file-other-frame "dired+" "`find-file-other-frame', but use file under cursor as default (`M-n').

(fn FILENAME &optional WILDCARDS)" t nil) (autoload 'diredp-find-a-file-other-window "dired+" "`find-file-other-window', but use file under cursor as default (`M-n').

(fn FILENAME &optional WILDCARDS)" t nil) (autoload 'diredp-find-a-file-read-args "dired+" "

(fn PROMPT MUSTMATCH)" nil nil) (autoload 'diredp-find-file-reuse-dir-buffer "dired+" "Like `dired-find-file', but reuse Dired buffers.
...
frame)." t nil) (autoload 'diredp-mouse-find-file-reuse-dir-buffer "dired+" "Like `dired-mouse-find-file', but reuse Dired buffers.
Unlike `dired-find-alternate-file' this does not use
`find-alternate-file' unless (1) the target is a directory that is not
yet visited as a Dired buffer, and (2) the current (Dired) buffer is
not visited also in some other window (possibly in an iconified
...
(fn EVENT &optional FIND-FILE-FUNC FIND-DIR-FUNC)" t nil) (defalias 'toggle-diredp-find-file-reuse-dir 'diredp-toggle-find-file-reuse-dir) (autoload 'diredp-toggle-find-file-reuse-dir "dired+" "Toggle whether Dired `find-file' commands reuse directories.
...
(fn FORCE-P)" t nil) (autoload 'diredp-omit-marked "dired+" "Omit lines of marked files.  Return the number of lines omitted." t nil) (autoload 'diredp-omit-unmarked "dired+" "Omit lines of unmarked files.  Return the number of lines omitted." t nil) (autoload 'diredp-ediff "dired+" "Compare file at cursor with file FILE2 using `ediff'.
...
(fn FILE2)" t nil) (autoload 'diredp-do-aggregate-apply-to-marked "dired+" "Aggregate results of applying a function to the marked files and dirs.
This command prompts you for the aggregate function, AGGREGATE-FUN.
...
(fn AGGREGATE-FUN &optional MARK-ARG MSGP)" t nil) (autoload 'diredp-do-aggregate-eval-in-marked "dired+" "Aggregate results of evaluating a sexp in the marked files and dirs.
This command prompts you for the aggregate function, AGGREGATE-FUN.
...
(fn AGGREGATE-FUN &optional MARK-ARG MSGP)" t nil) (autoload 'diredp-do-apply-to-marked "dired+" "Apply FUNCTION to the absolute name of each marked file.
...
(fn FUNCTION &optional ARG)" t nil) (autoload 'diredp-do-command-in-marked "dired+" "Invoke Emacs COMMAND in each marked file.
...
(fn COMMAND &optional ARG)" t nil) (autoload 'diredp-do-eval-in-marked "dired+" "Evaluate an Emacs-Lisp SEXP in each marked file.
...
(fn SEXP &optional ARG)" t nil) (autoload 'diredp-do-apply/eval-marked "dired+" "Apply a function to the marked files, or evaluate a sexp in them.
Return a list of the results.
...
(fn FUN/SEXP &optional ARG)" t nil) (autoload 'dired-do-compress "dired+" "Compress or uncompress marked (or next prefix argument) files.
...
(fn &optional ARG)" t nil) (autoload 'dired-do-byte-compile "dired+" "Byte compile marked Emacs Lisp files.
A prefix argument ARG specifies files to use instead of marked.
 An integer means use the next ARG files (previous -ARG, if < 0).
 `C-u': Use the current file (whether or not any are marked).
 `C-u C-u': Use all files in Dired, except directories.
...
(fn &optional ARG)" t nil) (autoload 'dired-do-load "dired+" "Load the marked Emacs Lisp files.
A prefix argument ARG specifies files to use instead of marked.
 An integer means use the next ARG files (previous -ARG, if < 0).
 `C-u': Use the current file (whether or not any are marked).
 `C-u C-u': Use all files in Dired, except directories.
...
(fn &optional ARG)" t nil) (autoload 'dired-do-search "dired+" "Search through all marked files for a match for REGEXP.
...
(fn REGEXP &optional ARG INTERACTIVEP)" t nil) (autoload 'dired-do-query-replace-regexp "dired+" "Do `query-replace-regexp' of FROM with TO, on all marked files.
...
(fn FROM TO &optional ARG INTERACTIVEP)" t nil) (autoload 'diredp-do-grep "dired+" "Run `grep' on marked (or next prefix arg) files.
A prefix argument behaves according to the ARG argument of
`dired-get-marked-files'.  In particular, `C-u C-u' operates on all
files in the Dired buffer.

(fn COMMAND-ARGS)" t nil) (autoload 'dired-maybe-insert-subdir "dired+" "Move to Dired subdirectory line or subdirectory listing.
...
(fn DIRNAME &optional SWITCHES NO-ERROR-IF-NOT-DIR-P)" t nil) (autoload 'diredp-hide-subdir-nomove "dired+" "Hide or unhide the current directory.
...
(fn ARG &optional NEXT)" t nil) (autoload 'dired-do-find-marked-files "dired+" "Find marked files, displaying all of them simultaneously.
...
(fn &optional ARG INTERACTIVEP)" t nil) (autoload 'diredp-up-directory "dired+" "Run Dired on parent directory of current directory.
...
(fn &optional OTHER-WINDOW)" t nil) (autoload 'diredp-up-directory-reuse-dir-buffer "dired+" "Like `diredp-up-directory', but reuse Dired buffers.
With a prefix arg, Dired the parent directory in another window.
...
(fn &optional OTHER-WINDOW)" t nil) (autoload 'diredp-next-line "dired+" "Move down lines then position cursor at filename.
...
(fn ARG)" t nil) (autoload 'diredp-previous-line "dired+" "Move up lines then position cursor at filename.
If `goal-column' is non-nil then put the cursor at that column.
Optional prefix ARG says how many lines to move; default is one line.
...
(fn ARG)" t nil) (autoload 'diredp-next-dirline "dired+" "Goto ARGth next directory file line.
If `diredp-wrap-around-flag' is non-nil then wrap around if none is
found before the buffer beginning (buffer end, if ARG is negative).
Otherwise, raise an error or, if NO-ERROR-IF-NOT-FOUND is nil, return
nil.

(fn ARG &optional OPOINT)" t nil) (autoload 'diredp-prev-dirline "dired+" "Goto ARGth previous directory file line.

(fn ARG)" t nil) (autoload 'diredp-next-subdir "dired+" "Go to the next subdirectory, regardless of level.
...
(fn ARG &optional NO-ERROR-IF-NOT-FOUND NO-SKIP)" t nil) (autoload 'diredp-prev-subdir "dired+" "Go to the previous subdirectory, regardless of level.
When called interactively and not on a subdir line, go to this subdir's line.
Otherwise, this is a mirror image of `diredp-next-subdir'.

(fn ARG &optional NO-ERROR-IF-NOT-FOUND NO-SKIP)" t nil) (autoload 'dired-do-flagged-delete "dired+" "In Dired, delete the files flagged for deletion.
...
(fn &optional NO-MSG)" t nil) (autoload 'dired-do-delete "dired+" "Delete all marked (or next ARG) files.
NOTE: This deletes marked, not flagged, files.
`dired-recursive-deletes' controls whether deletion of
non-empty directories is allowed.

(fn &optional ARG)" t nil) (autoload 'dired-repeat-over-lines "dired+" "Repeat FUNCTION over this line and the next ARG lines.
(Negative ARG means previous, not next.)
Non-file lines are skipped.

(fn ARG FUNCTION)" nil nil) (autoload 'dired-mark-files-regexp "dired+" "Mark all file names matching REGEXP for use in later commands.
...
(fn REGEXP &optional MARKER-CHAR NAME-FORM)" t nil) (autoload 'dired-mark-files-containing-regexp "dired+" "Mark files with contents containing a REGEXP match.
...
(fn REGEXP &optional MARKER-CHAR)" t nil) (autoload 'dired-mark-symlinks "dired+" "Mark all symbolic links.
With prefix argument, unmark or unflag all those files.

(fn UNFLAG-P)" t nil) (autoload 'dired-mark-directories "dired+" "Mark all directory file lines except `.' and `..'.
With prefix argument, unmark or unflag the files instead.

(fn UNFLAG-P)" t nil) (autoload 'dired-mark-executables "dired+" "Mark all executable files.
With prefix argument, unmark or unflag the files instead.

(fn UNFLAG-P)" t nil) (autoload 'dired-flag-auto-save-files "dired+" "Flag for deletion files whose names suggest they are auto save files.
A prefix argument says to unmark or unflag the files instead.

(fn &optional UNFLAG-P)" t nil) (autoload 'diredp-capitalize "dired+" "Rename all marked (or next ARG) files by capitalizing them.
Makes the first char of the name uppercase and the others lowercase.

(fn &optional ARG)" t nil) (autoload 'diredp-delete-this-file "dired+" "In Dired, delete this file, upon confirmation.
...
(fn &optional USE-TRASH-CAN)" t nil) (autoload 'diredp-capitalize-this-file "dired+" "In Dired, rename this file by capitalizing it.
Makes the first char of the name uppercase and the others lowercase." t nil) (autoload 'diredp-downcase-this-file "dired+" "In Dired, rename this file to lower case." t nil) (autoload 'diredp-upcase-this-file "dired+" "In Dired, rename this file to upper case." t nil) (autoload 'diredp-rename-this-file "dired+" "In Dired, rename this file." t nil) (autoload 'diredp-copy-this-file "dired+" "In Dired, copy this file." t nil) (autoload 'diredp-relsymlink-this-file "dired+" "In Dired, make a relative symbolic link to file on cursor line." t nil) (autoload 'diredp-symlink-this-file "dired+" "In Dired, make a symbolic link to this file." t nil) (autoload 'diredp-hardlink-this-file "dired+" "In Dired, add a name (hard link) to this file." t nil) (autoload 'diredp-print-this-file "dired+" "In Dired, print this file." t nil) (autoload 'diredp-grep-this-file "dired+" "In Dired, grep this file." t nil) (autoload 'diredp-compress-this-file "dired+" "In Dired, compress or uncompress this file." t nil) (autoload 'diredp-async-shell-command-this-file "dired+" "Run a shell COMMAND asynchronously on the file on the Dired cursor line.
...
(fn COMMAND FILELIST)" t nil) (autoload 'diredp-shell-command-this-file "dired+" "In Dired, run a shell COMMAND on this file.

(fn COMMAND FILELIST)" t nil) (autoload 'diredp-bookmark-this-file "dired+" "In Dired, bookmark this file.
See `diredp-do-bookmark'.

(fn &optional PREFIX)" t nil) (autoload 'diredp-tag-this-file "dired+" "In Dired, add some tags to this file.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional PREFIX)" t nil) (autoload 'diredp-untag-this-file "dired+" "In Dired, remove some tags from this file.
With a prefix arg, remove all tags from the file.
You need library `bookmark+.el' to use this command.

(fn TAGS &optional PREFIX ARG)" t nil) (autoload 'diredp-remove-all-tags-this-file "dired+" "In Dired, remove all tags from this file.
You need library `bookmark+.el' to use this command.

(fn &optional PREFIX MSGP)" t nil) (autoload 'diredp-paste-add-tags-this-file "dired+" "In Dired, add previously copied tags to this file.
See `diredp-paste-add-tags'.
You need library `bookmark+.el' to use this command.

(fn &optional PREFIX MSGP)" t nil) (autoload 'diredp-paste-replace-tags-this-file "dired+" "In Dired, replace tags for this file with previously copied tags.
See `diredp-paste-replace-tags'.
You need library `bookmark+.el' to use this command.

(fn &optional PREFIX MSGP)" t nil) (autoload 'diredp-set-tag-value-this-file "dired+" "In Dired, Set value of TAG to VALUE for this file.
See `diredp-set-tag-value'.
You need library `bookmark+.el' to use this command.

(fn TAG VALUE &optional PREFIX MSGP)" t nil) (autoload 'diredp-copy-tags-this-file "dired+" "In Dired, copy the tags from this file, so you can paste them to another.
See `diredp-copy-tags'.
You need library `bookmark+.el' to use this command.

(fn &optional PREFIX MSGP)" t nil) (autoload 'diredp-mouse-copy-tags "dired+" "In Dired, copy the tags from this file, so you can paste them to another.
You need library `bookmark+.el' to use this command.

(fn EVENT)" t nil) (defalias 'diredp-show-metadata 'diredp-describe-autofile) (autoload 'diredp-describe-autofile "dired+" "Show the metadata for the file of the current line.
...
(fn &optional INTERNAL-FORM-P)" t nil) (defalias 'diredp-show-metadata-for-marked 'diredp-describe-marked-autofiles) (autoload 'diredp-describe-marked-autofiles "dired+" "Show metadata for the marked files.
...
(fn &optional INTERNAL-FORM-P INTERACTIVEP DETAILS)" t nil) (autoload 'diredp-byte-compile-this-file "dired+" "In Dired, byte compile the (Lisp source) file on the cursor line." t nil) (autoload 'diredp-load-this-file "dired+" "In Dired, load this file." t nil) (autoload 'diredp-chmod-this-file "dired+" "In Dired, change the mode of this file." t nil) (autoload 'dired-mark-sexp "dired+" "Mark files for which PREDICATE returns non-nil.
...
(fn PREDICATE &optional UNMARK-P)" t nil) (autoload 'diredp-mark "dired+" "Mark current line, lines in active region, or lines in a listing.
...
(fn ARG &optional CHAR)" t nil) (autoload 'diredp-mark-with-char "dired+" "Mark this line with CHAR.
With numeric prefix arg N, mark the next N lines.

(fn CHAR &optional ARG)" t nil) (autoload 'diredp-mark-region-files-with-char "dired+" "Mark lines in active region with CHAR.
With non-nil prefix arg, unmark CHAR instead.

(fn CHAR &optional UNMARK-P)" t nil) (autoload 'diredp-mark-region-files "dired+" "Mark all of the files in the current region (if it is active).
With non-nil prefix arg, unmark them instead.

(fn &optional UNMARK-P)" t nil) (autoload 'diredp-unmark-region-files "dired+" "Unmark all of the files in the current region (if it is active).
With non-nil prefix arg, mark them instead.

(fn &optional MARK-P)" t nil) (autoload 'diredp-flag-region-files-for-deletion "dired+" "Flag all of the files in the current region (if it is active) for deletion." t nil) (autoload 'diredp-toggle-marks-in-region "dired+" "Toggle marks in the region.

(fn BEG END)" t nil) (autoload 'diredp-mouse-3-menu "dired+" "Dired pop-up `mouse-3' menu, for files in selection or current line.

(fn EVENT)" t nil) (autoload 'diredp-find-file-other-frame "dired+" "In Dired, visit this file or directory in another frame." t nil) (autoload 'diredp-mouse-find-file-other-frame "dired+" "In Dired, visit file or directory clicked on in another frame.

(fn EVENT)" t nil) (autoload 'dired-mouse-find-file-other-window "dired+" "In Dired, visit the file or directory name you click on.

(fn EVENT)" t nil) (autoload 'diredp-mouse-view-file "dired+" "Examine this file in view mode, returning to Dired when done.
When file is a directory, show it in this buffer if it is inserted;
otherwise, display it in another buffer.

(fn EVENT)" t nil) (autoload 'diredp-mouse-ediff "dired+" "Compare this file (pointed by mouse) with file FILE2 using `ediff'.
...
(fn EVENT)" t nil) (autoload 'diredp-mouse-diff "dired+" "Compare this file (pointed by mouse) with file FILE2 using `diff'.
...
(fn EVENT &optional SWITCHES)" t nil) (autoload 'diredp-mouse-backup-diff "dired+" "Diff this file with its backup file or vice versa.
...
(fn EVENT)" t nil) (autoload 'diredp-mouse-mark "dired+" "In Dired, mark this file.
If on a subdir headerline, mark all its files except `.' and `..'.

Use \\[dired-unmark-all-files] to remove all marks,
and \\[dired-unmark] on a subdir to remove the marks in this subdir.

(fn EVENT)" t nil) (autoload 'diredp-mouse-unmark "dired+" "In Dired, unmark this file.
If looking at a subdir, unmark all its files except `.' and `..'.

(fn EVENT)" t nil) (autoload 'diredp-mouse-mark/unmark "dired+" "Mark/unmark file or directory at mouse EVENT.

(fn EVENT)" t nil) (autoload 'diredp-mouse-mark-region-files "dired+" "Mark files between point and the mouse.

(fn EVENT)" t nil) (autoload 'diredp-mouse-mark/unmark-mark-region-files "dired+" "Mark/unmark file or mark files in region.
...
(fn EVENT)" t nil) (autoload 'diredp-mouse-flag-file-deletion "dired+" "In Dired, flag this file for deletion.
If on a subdir headerline, mark all its files except `.' and `..'.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-copy "dired+" "In Dired, copy this file.
This normally preserves the last-modified date when copying.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-rename "dired+" "In Dired, rename this file.

(fn EVENT)" t nil) (autoload 'diredp-mouse-upcase "dired+" "In Dired, rename this file to upper case.

(fn EVENT)" t nil) (autoload 'diredp-mouse-downcase "dired+" "In Dired, rename this file to lower case.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-delete "dired+" "In Dired, delete this file, upon confirmation.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-shell-command "dired+" "Run a shell COMMAND on this file.
...
(fn EVENT)" t nil) (autoload 'diredp-mouse-do-symlink "dired+" "Make symbolic link to this file.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-hardlink "dired+" "Make hard link (alias) to this file.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-print "dired+" "Print this file.
Uses the shell command coming from variables `lpr-command' and
`lpr-switches' as default.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-grep "dired+" "Run grep against this file.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-compress "dired+" "Compress or uncompress this file.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-byte-compile "dired+" "Byte compile this file.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-load "dired+" "Load this Emacs Lisp file.

(fn EVENT)" t nil) (autoload 'diredp-mouse-do-chmod "dired+" "Change the mode of this file.
This calls chmod, so symbolic modes like `g+w' are allowed.

(fn EVENT)" t nil) (autoload 'diredp-describe-mode "dired+" "Describe Dired mode, including Dired+ features.
This is `describe-mode' plus a description of Dired+ features.
For just the latter, use \\<dired-mode-map>`\\[diredp-dired-plus-help]'.

(fn &optional BUFFER)" t nil) (autoload 'diredp-dired-plus-help "dired+" "Describe Dired+." t nil) (autoload 'diredp-send-bug-report "dired+" "Send a bug report about a Dired+ problem." t nil) (autoload 'diredp-visit-next-file "dired+" "Move down a line and visit its file in another window.
...
(fn &optional ARG)" t nil) (autoload 'diredp-visit-previous-file "dired+" "Move up a line and visit its file in another window.
...
(fn &optional ARG)" t nil) (autoload 'diredp-visit-this-file "dired+" "View the file on this line in another window in the same frame.
...
windows there, then delete its window (toggle : show/hide the file)." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dired+" '("dired"))) (provide 'dired+-autoloads)) "org" ((ob-comint org-ctags ox-texinfo ol-doi org-refile org-version org-num ol-mhe ob-shell org-attach ob-C org-entities ob-dot ob-sql ol-eww org-datetree org-macro ob-eval ob-abc ob-groovy ob-shen ox-icalendar org-mobile ob-processing oc-csl ob-picolisp ob-octave org-table ox-html ol ob-plantuml ol-docview ob-exp ob-ditaa ob-scheme ol-gnus org-mouse org-inlinetask ob-fortran ob-haskell org-id ob-vala oc ob-css org-compat ob-coq org-element ob ob-calc ob-python org-agenda ob-ocaml org-tempo ob-ref ob-tangle ob-lilypond ob-clojure org-lint ol-eshell ox-latex org-pcomplete org-duration ox-beamer ol-info ob-ebnf ob-table ol-rmail ox-odt org-protocol ob-latex org-archive ol-w3m ob-sed ob-perl ob-eshell org-plot org-clock ob-awk ob-stan org-list ob-sqlite org-macs ox-man ol-bbdb org-loaddefs ol-irc org ob-J ob-ledger org-capture ob-asymptote org-colview org-goto ob-R ob-ruby ob-sass ob-matlab ox oc-natbib ob-core ob-makefile org-timer ob-org ob-forth ob-io oc-biblatex ob-lob ob-gnuplot org-faces org-habit ox-koma-letter ob-js ob-screen org-footnote ob-mscgen oc-basic ol-bibtex ob-hledger ob-java ob-lua ox-md org-install ox-ascii org-keys ob-lisp org-attach-git ob-emacs-lisp ob-maxima org-crypt org-feed org-src ox-org org-indent ox-publish)) "org-contrib" ((org-effectiveness ol-wl ob-mathomatic org-contrib org-static-mathjax org-checklist org-secretary ob-spice ob-mathematica ob-php org-notify org-bibtex-extras org-panel ox-taskjuggler org-velocity ol-vm org-learn org-interactive-query ob-tcl ox-deck org-eval org-toc ob-csharp org-choose ox-confluence org-attach-embedded-images org-eval-light ob-sclang ob-oz org-contribdir org-mairix org-collector ob-arduino ob-fomus ol-bookmark ol-git-link org-screenshot ox-groff org-link-edit org-screen ob-smiles orgtbl-sqlinsert ob-vbnet ob-julia ox-bibtex org-license org-registry org-sudoku ol-man ol-mew ob-clojure-literate ob-stata ox-extra ol-elisp-symbol org-track ob-eukleides org-contrib-autoloads org-wikinodes org-mac-iCal org-depend org-passwords ox-koma-letter org-annotate-file ob-redis ox-s5 ox-freemind org-invoice org-expiry org-eldoc ol-notmuch org-mac-link org-contacts ox-rss) (autoload 'org-babel-execute:arduino "ob-arduino" "org-babel arduino hook.
...
(fn &optional SUBTREEP VISIBLE-ONLY)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-taskjuggler" '("org-taskjuggler-"))) (provide 'org-contrib-autoloads)) "htmlize" ((htmlize-autoloads htmlize) (autoload 'htmlize-buffer "htmlize" "Convert BUFFER to HTML, preserving colors and decorations.
...
(fn URL &optional IGNORE)" t nil) (autoload 'helm-browse-url-nyxt "helm-net" "Browse URL with next browser.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-utils" '("helm-" "with-helm-display-marked-candidates"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "helm-x-files" '("helm-"))) (provide 'helm-autoloads)) "parsebib" ((parsebib-autoloads parsebib) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "parsebib" '("parsebib-"))) (provide 'parsebib-autoloads)) "s" ((s s-autoloads) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "s" '("s-"))) (provide 's-autoloads)) "f" ((f f-autoloads) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "f" '("f-"))) (provide 'f-autoloads)) "biblio-core" ((biblio-core-autoloads biblio-core) (autoload 'biblio-lookup "biblio-core" "Perform a search using BACKEND, and QUERY.
...
(fn &optional BACKEND QUERY)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "biblio-core" '("biblio-"))) (provide 'biblio-core-autoloads)) "biblio" ((biblio-crossref biblio-ieee biblio-dissemin biblio-arxiv biblio-hal biblio-dblp biblio-autoloads biblio-doi biblio-download biblio biblio-pkg) (autoload 'biblio-arxiv-backend "biblio-arxiv" "A arXiv backend for biblio.el.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bibtex-completion" '("bibtex-completion-"))) (provide 'bibtex-completion-autoloads)) "helm-bibtex" ((helm-bibtex-autoloads helm-bibtex) (autoload 'helm-bibtex "helm-bibtex" "Search BibTeX entries.
...
(fn &optional FILENAMES BUFFER-NAME DISPLAY-P)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pdf-virtual" '("pdf-virtual-"))) (provide 'pdf-tools-autoloads)) "org-ref" ((org-ref-helm-cite org-ref-ivy org-ref-arxiv org-ref-citeproc org-ref-helm-bibtex org-ref-pubmed org-ref-scopus org-ref-helm x2bib org-ref-scifinder org-ref-reftex org-ref-pgk org-ref-autoloads org-ref-ivy-cite org-ref-sci-id org-ref-url-utils doi-utils org-ref-utils org-ref-bibtex nist-webbook org-ref-worldcat org-ref-core org-ref-glossary org-ref-pdf org-ref-wos org-ref-latex org-ref org-ref-isbn) (autoload 'doi-utils-get-bibtex-entry-pdf "doi-utils" "Download pdf for entry at point if the pdf does not already exist locally.
...
(fn MEDFILE &optional VERBOSE)" t nil) (autoload 'clean-entries "x2bib" "Map over bibtex entries and clean them." t nil) (provide 'org-ref-autoloads)) "orgonomic" ((orgonomic orgonomic-autoloads) (autoload 'orgonomic-return "orgonomic" "Add new list item, heading or table row with RET.
A double return on an empty element deletes it.
Use a prefix arg to get regular RET. 

(fn &optional IGNORE)" t nil) (autoload 'orgonomic-shift-return "orgonomic" "Copy down if in table or insert newline and indent.

(fn N)" t nil) (autoload 'orgonomic-delete-backward-char "orgonomic" "Delete checkboxes, list item bullets and demote headlines.

(fn &optional N)" t nil) (autoload 'orgonomic-minus "orgonomic" "Convert a headline to a list item if at the beginning of an empty headline, otherwise insert -.

(fn N)" t nil) (autoload 'orgonomic-mode "orgonomic" "When active, RET and backspace will behave more like they would in a word
processor.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "orgonomic" '("orgonomic-"))) (provide 'orgonomic-autoloads)) "org-journal" ((org-journal org-journal-autoloads) (add-hook 'calendar-today-visible-hook 'org-journal-mark-entries) (add-hook 'calendar-today-invisible-hook 'org-journal-mark-entries) (autoload 'org-journal-mode "org-journal" "Mode for writing or viewing entries written in the journal.
...
non-nil and title is not from filename, use it as the title." t nil) (autoload 'deft "deft" "Switch to *Deft* buffer and load files." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "deft" '("deft-" "org-deft-store-link"))) (provide 'deft-autoloads)) "emacsql" ((emacsql-compiler emacsql emacsql-autoloads) (autoload 'emacsql-show-last-sql "emacsql" "Display the compiled SQL of the s-expression SQL expression before point.
A prefix argument causes the SQL to be printed into the current buffer.

(fn &optional PREFIX)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "emacsql" '("emacsql-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "emacsql-compiler" '("emacsql-"))) (provide 'emacsql-autoloads)) "emacsql-sqlite" ((emacsql-sqlite emacsql-sqlite-autoloads) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "emacsql-sqlite" '("emacsql-sqlite-"))) (provide 'emacsql-sqlite-autoloads)) "org-roam" ((org-roam-utils org-roam-db org-roam-capture org-roam-migrate org-roam-dailies org-roam-macs org-roam org-roam-overlay org-roam-completion org-roam-autoloads org-roam-mode org-roam-protocol org-roam-compat org-roam-graph) (autoload 'org-roam-setup "org-roam" "Setup Org-roam and initialize its database.
This will install the needed hooks and advices to keep everything
in sync with the connected databases." t nil) (autoload 'org-roam-node-find "org-roam" "Find and open an Org-roam node by its title or alias.
INITIAL-INPUT is the initial input for the prompt.
FILTER-FN is a function to filter out nodes: it takes an `org-roam-node',
and when nil is returned the node will be filtered out.
If OTHER-WINDOW, visit the NODE in another window.

(fn &optional OTHER-WINDOW INITIAL-INPUT FILTER-FN)" t nil) (autoload 'org-roam-node-insert "org-roam" "Find an Org-roam node and insert (where the point is) an \"id:\" link to it.
FILTER-FN is a function to filter out nodes: it takes an `org-roam-node',
and when nil is returned the node will be filtered out.

(fn &optional FILTER-FN)" t nil) (autoload 'org-roam-node-random "org-roam" "Find and open a random Org-roam node.
With prefix argument OTHER-WINDOW, visit the node in another
window instead.

(fn &optional OTHER-WINDOW)" t nil) (autoload 'org-roam-ref-find "org-roam" "Find and open an Org-roam node that's dedicated to a specific ref.
INITIAL-INPUT is the initial input to the prompt.
FILTER-FN is a function to filter out nodes: it takes an `org-roam-node',
and when nil is returned the node will be filtered out.

(fn &optional INITIAL-INPUT FILTER-FN)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam" '("org-roam-"))) (autoload 'org-roam-capture- "org-roam-capture" "Main entry point.
...
(fn &key GOTO KEYS NODE INFO PROPS TEMPLATES)" nil nil) (autoload 'org-roam-capture "org-roam-capture" "Launches an `org-capture' process for a new or existing note.
This uses the templates defined at `org-roam-capture-templates'.
Arguments GOTO and KEYS see `org-capture'.

(fn &optional GOTO KEYS)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-capture" '("org-roam-capture-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-compat" '("org-roam--directory-files-recursively"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-completion" '("org-roam-"))) (autoload 'org-roam-dailies-find-directory "org-roam-dailies" "Find and open `org-roam-dailies-directory'." t nil) (autoload 'org-roam-dailies-capture-today "org-roam-dailies" "Create an entry in the daily-note for today.
...
(fn &optional PREFER-FUTURE)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-dailies" '("org-roam-dailies-"))) (autoload 'org-roam-db-sync "org-roam-db" "Synchronize the cache state with the current Org files on-disk.
If FORCE, force a rebuild of the cache from scratch.

(fn &optional FORCE)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-db" '("emacsql-constraint" "org-roam-"))) (autoload 'org-roam-graph "org-roam-graph" "Build and possibly display a graph for NODE.
ARG may be any of the following values:
  - nil       show the graph.
  - `\\[universal-argument]'     show the graph for NODE.
  - `\\[universal-argument]' N   show the graph for NODE limiting nodes to N steps.

(fn &optional ARG NODE)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-graph" '("org-roam-graph-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-macs" '("org-roam-"))) (autoload 'org-roam-migrate-wizard "org-roam-migrate" "Migrate all notes from to be compatible with Org-roam v2.
1. Convert all notes from v1 format to v2.
2. Rebuild the cache.
3. Replace all file links with ID links." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-migrate" '("org-roam-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-mode" '("org-roam-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-overlay" '("org-roam-overlay-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-protocol" '("org-roam-protocol-"))) (autoload 'org-roam-version "org-roam-utils" "Return `org-roam' version.
Interactively, or when MESSAGE is non-nil, show in the echo area.

(fn &optional MESSAGE)" t nil) (autoload 'org-roam-diagnostics "org-roam-utils" "Collect and print info for `org-roam' issues." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-roam-utils" '("org-roam-"))) (provide 'org-roam-autoloads)) "markdown-mode" ((markdown-mode markdown-mode-autoloads) (autoload 'markdown-mode "markdown-mode" "Major mode for editing Markdown files.
...
(fn BOUND)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "texmathp" '("texmathp-"))) (autoload 'toolbarx-install-toolbar "toolbar-x") (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "toolbar-x" '("toolbarx-"))) (provide 'auctex-autoloads)) "auctex-latexmk" ((auctex-latexmk-autoloads auctex-latexmk) (autoload 'auctex-latexmk-setup "auctex-latexmk" "Add LatexMk command to TeX-command-list." nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "auctex-latexmk" '("Latexmk-sentinel" "TeX-run-latexmk" "auctex-latexmk-"))) (provide 'auctex-latexmk-autoloads)) "cdlatex" ((cdlatex-autoloads cdlatex) (autoload 'turn-on-cdlatex "cdlatex" "Turn on CDLaTeX minor mode." nil nil) (autoload 'cdlatex-mode "cdlatex" "Minor mode for editing scientific LaTeX documents.  Here is a
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cdlatex" '("cdlatex-"))) (provide 'cdlatex-autoloads)) "bibtex-actions" ((bibtex-actions bibtex-actions-autoloads bibtex-actions-org-cite) (autoload 'bibtex-actions-refresh "bibtex-actions" "Reload the candidates cache.
...
(fn &optional FORCE-REBUILD-CACHE)" t nil) (autoload 'bibtex-actions-insert-preset "bibtex-actions" "Prompt for and insert a predefined search." t nil) (autoload 'bibtex-actions-open "bibtex-actions" "Open PDF, or URL or DOI link.
Opens the PDF(s) associated with the KEYS.  If multiple PDFs are
found, ask for the one to open using \342\200\230completing-read\342\200\231.  If no
PDF is found, try to open a URL or DOI in the browser instead.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-open-pdf "bibtex-actions" "Open PDF associated with the KEYS.
If multiple PDFs are found, ask for the one to open using
\342\200\230completing-read\342\200\231.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-open-link "bibtex-actions" "Open URL or DOI link associated with the KEYS in a browser.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-insert-citation "bibtex-actions" "Insert citation for the KEYS.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-insert-reference "bibtex-actions" "Insert formatted reference(s) associated with the KEYS.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-insert-key "bibtex-actions" "Insert BibTeX KEYS.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-insert-bibtex "bibtex-actions" "Insert BibTeX entry associated with the KEYS.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-add-pdf-attachment "bibtex-actions" "Attach PDF(s) associated with the KEYS to email.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-open-notes "bibtex-actions" "Open notes associated with the KEYS.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-open-entry "bibtex-actions" "Open BibTeX entry associated with the KEYS.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-add-pdf-to-library "bibtex-actions" "Add PDF associated with the KEYS to library.
The PDF can be added either from an open buffer, a file, or a
URL.
With prefix, rebuild the cache before offering candidates.

(fn KEYS)" t nil) (autoload 'bibtex-actions-dwim "bibtex-actions" "Run the default action on citation keys found at point." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bibtex-actions" '("bibtex-actions-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bibtex-actions-org-cite" '("bibtex-actions-org-cite-"))) (provide 'bibtex-actions-autoloads)) "ebib" ((ebib-keywords ebib-autoloads ebib-db ebib-reading-list ebib-notes ebib-biblio ebib-filters ebib-utils ebib org-ebib) (autoload 'ebib "ebib" "Ebib, a BibTeX database manager.
Optional argument FILE is a file to load.  If FILE is already
loaded, switch to it.  If KEY is given, jump to it.

(fn &optional FILE KEY)" t nil) (autoload 'ebib-init "ebib" "Initialise Ebib.
...
in the user's init file." nil nil) (autoload 'ebib-insert-citation "ebib" "Insert a citation at POINT.
...
option `ebib-citation-insert-multiple'." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib" '("ebib-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib-biblio" '("ebib-biblio-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib-db" '("ebib-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib-filters" '("ebib-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib-keywords" '("ebib-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib-notes" '("ebib-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib-reading-list" '("ebib-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ebib-utils" '("ebib-" "with-"))) (autoload 'org-ebib-open "org-ebib" "Open Ebib and jump to ENTRY.

(fn ENTRY)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-ebib" '("org-ebib-"))) (provide 'ebib-autoloads)) "web-mode" ((web-mode-autoloads web-mode) (autoload 'web-mode "web-mode" "Major mode for editing web templates.

(fn)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "web-mode" '("web-mode-"))) (provide 'web-mode-autoloads)) "emmet-mode" ((emmet-mode emmet-mode-autoloads) (autoload 'emmet-expand-line "emmet-mode" "Replace the current line's emmet expression with the corresponding expansion.
...
(fn COUNT)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "emmet-mode" '("emmet-"))) (provide 'emmet-mode-autoloads)) "web-completion-data" ((web-completion-data web-completion-data-autoloads) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "web-completion-data" '("web-completion-data-"))) (provide 'web-completion-data-autoloads)) "company-web" ((company-web-autoloads company-web-jade company-web-slim company-web-html company-web) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "company-web" '("company-web-"))) (autoload 'company-web-html "company-web-html" "`company-mode' completion back-end for `html-mode' and `web-mode'.

(fn COMMAND &optional ARG &rest IGNORED)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "company-web-html" '("company-web-html-"))) (autoload 'company-web-jade "company-web-jade" "`company-mode' completion back-end for `jade-mode'.

(fn COMMAND &optional ARG &rest IGNORED)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "company-web-jade" '("company-web-jade-"))) (autoload 'company-web-slim "company-web-slim" "`company-mode' completion back-end for `slim-mode'.

(fn COMMAND &optional ARG &rest IGNORED)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "company-web-slim" '("company-web-slim-"))) (provide 'company-web-autoloads)) "pretty-hydra" ((pretty-hydra-autoloads pretty-hydra) (autoload 'pretty-hydra-define "pretty-hydra" "Define a pretty hydra with given NAME, BODY options and HEADS-PLIST.
...
what diminished modes would be on the mode-line if they were still minor." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "diminish" '("diminish"))) (provide 'diminish-autoloads)) "ox-hugo" ((ox-hugo ox-blackfriday ox-hugo-autoloads ox-hugo-pandoc-cite org-hugo-auto-export-mode) (autoload 'org-hugo-auto-export-mode "org-hugo-auto-export-mode" "Toggle auto exporting the Org file using `ox-hugo'.
...
(fn PLIST FILENAME PUB-DIR)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-blackfriday" '("org-blackfriday-"))) (put 'org-hugo-base-dir 'safe-local-variable 'stringp) (put 'org-hugo-section 'safe-local-variable 'stringp) (put 'org-hugo-front-matter-format 'safe-local-variable 'stringp) (put 'org-hugo-footer 'safe-local-variable 'stringp) (put 'org-hugo-preserve-filling 'safe-local-variable 'booleanp) (put 'org-hugo-delete-trailing-ws 'safe-local-variable 'booleanp) (put 'org-hugo-use-code-for-kbd 'safe-local-variable 'booleanp) (put 'org-hugo-allow-spaces-in-tags 'safe-local-variable 'booleanp) (put 'org-hugo-prefer-hyphen-in-tags 'safe-local-variable 'booleanp) (put 'org-hugo-auto-set-lastmod 'safe-local-variable 'booleanp) (put 'org-hugo-suppress-lastmod-period 'safe-local-variable 'floatp) (put 'org-hugo-export-with-toc 'safe-local-variable (lambda (x) (or (booleanp x) (integerp x)))) (put 'org-hugo-export-with-section-numbers 'safe-local-variable (lambda (x) (or (booleanp x) (equal 'onlytoc x) (integerp x)))) (put 'org-hugo-default-static-subdirectory-for-externals 'safe-local-variable 'stringp) (put 'org-hugo-export-creator-string 'safe-local-variable 'stringp) (put 'org-hugo-date-format 'safe-local-variable 'stringp) (put 'org-hugo-paired-shortcodes 'safe-local-variable 'stringp) (put 'org-hugo-link-desc-insert-type 'safe-local-variable 'booleanp) (autoload 'org-hugo-slug "ox-hugo" "Convert string STR to a `slug' and return that string.
...
(fn STR)" nil nil) (autoload 'org-hugo-export-as-md "ox-hugo" "Export current buffer to a Hugo-compatible Markdown buffer.
...
buffer and returned as a string in Org format." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-hugo" '("org-hugo-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-hugo-pandoc-cite" '("org-hugo-pandoc-cite-"))) (provide 'ox-hugo-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 145 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 9 "melpa" nil "gnu-elpa-mirror" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "use-package-ensure-system-package" nil "system-packages" nil "use-package-chords" nil "bind-chord" nil "key-chord" nil "exec-path-from-shell" nil "cl-lib" nil "hc-zenburn-theme" nil "modus-themes" nil "general" nil "flycheck" nil "dash" nil "pkg-info" nil "epl" nil "let-alist" nil "seq" nil "selectrum" nil "prescient" nil "selectrum-prescient" nil "consult" nil "consult-selectrum" nil "marginalia" nil "embark" nil "embark-consult" nil "avy" nil "ace-window" nil "shrink-whitespace" nil "company" nil "expand-region" nil "smex" nil "magit" nil "git-commit" nil "transient" nil "with-editor" nil "magit-section" nil "reveal-in-osx-finder" nil "multiple-cursors" nil "hungry-delete" nil "smartparens" nil "aggressive-indent" nil "undo-tree" nil "evil-nerd-commenter" nil "which-key" nil "windmove" nil "wgrep" nil "yasnippet" nil "wc-mode" nil "company-prescient" nil "crux" nil "fish-mode" nil "olivetti" nil "dired+" nil "org" (org :type git :repo "https://code.orgmode.org/bzg/org-mode.git" :local-repo "org" :depth full :pre-build (straight-recipes-org-elpa--build) :build (:not autoloads) :files (:defaults "lisp/*.el" ("etc/styles/" "etc/styles/*"))) "org-contrib" (org-contrib :type git :includes (ob-arduino ob-clojure-literate ob-csharp ob-eukleides ob-fomus ob-julia ob-mathematica ob-mathomatic ob-oz ob-php ob-redis ob-sclang ob-smiles ob-spice ob-stata ob-tcl ob-vbnet ol-bookmark ol-elisp-symbol ol-git-link ol-man ol-mew ol-notmuch ol-vm ol-wl org-annotate-file org-attach-embedded-images org-bibtex-extras org-checklist org-choose org-collector org-contacts org-contribdir org-depend org-effectiveness org-eldoc org-eval org-eval-light org-expiry org-interactive-query org-invoice org-learn org-license org-mac-iCal org-mac-link org-mairix org-notify org-panel org-passwords org-registry org-screen org-screenshot org-secretary org-static-mathjax org-sudoku orgtbl-sqlinsert org-toc org-track org-velocity org-wikinodes ox-bibtex ox-confluence ox-deck ox-extra ox-freemind ox-groff ox-koma-letter ox-rss ox-s5 ox-taskjuggler) :repo "https://git.sr.ht/~bzg/org-contrib" :files (:defaults "lisp/*.el")) "org-ref" nil "htmlize" nil "helm" nil "async" nil "popup" nil "helm-core" nil "helm-bibtex" nil "bibtex-completion" nil "parsebib" nil "s" nil "f" nil "biblio" nil "biblio-core" nil "ivy" nil "hydra" nil "lv" nil "pdf-tools" nil "tablist" nil "orgonomic" nil "org-journal" nil "deft" nil "org-roam" nil "emacsql" nil "emacsql-sqlite" nil "markdown-mode" nil "auctex" nil "auctex-latexmk" nil "cdlatex" nil "bibtex-actions" nil "ebib" nil "web-mode" nil "emmet-mode" nil "company-web" nil "web-completion-data" nil "major-mode-hydra" nil "pretty-hydra" nil "diminish" nil "ox-hugo" nil)) melpa #s(hash-table size 97 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "use-package-ensure-system-package" (use-package-ensure-system-package :type git :flavor melpa :files ("use-package-ensure-system-package.el" "use-package-ensure-system-package-pkg.el") :host github :repo "jwiegley/use-package") "system-packages" (system-packages :type git :flavor melpa :host gitlab :repo "jabranham/system-packages") "use-package-chords" (use-package-chords :type git :flavor melpa :files ("use-package-chords.el" "use-package-chords-pkg.el") :host github :repo "jwiegley/use-package") "bind-chord" (bind-chord :type git :flavor melpa :files ("bind-chord.el" "bind-chord-pkg.el") :host github :repo "jwiegley/use-package") "key-chord" (key-chord :type git :flavor melpa :host github :repo "emacsorphanage/key-chord") "exec-path-from-shell" (exec-path-from-shell :type git :flavor melpa :host github :repo "purcell/exec-path-from-shell") "cl-lib" nil "hc-zenburn-theme" (hc-zenburn-theme :type git :flavor melpa :files ("hc-zenburn-theme.el" "hc-zenburn-theme-pkg.el") :host github :repo "edran/hc-zenburn-emacs") "modus-themes" (modus-themes :type git :flavor melpa :branch "main" :host gitlab :repo "protesilaos/modus-themes") "general" (general :type git :flavor melpa :host github :repo "noctuid/general.el") "flycheck" (flycheck :type git :flavor melpa :host github :repo "flycheck/flycheck") "dash" (dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "pkg-info" (pkg-info :type git :flavor melpa :host github :repo "emacsorphanage/pkg-info") "epl" (epl :type git :flavor melpa :host github :repo "cask/epl") "let-alist" nil "seq" nil "selectrum" (selectrum :type git :flavor melpa :host github :repo "raxod502/selectrum") "prescient" (prescient :type git :flavor melpa :files ("prescient.el" "prescient-pkg.el") :host github :repo "raxod502/prescient.el") "selectrum-prescient" (selectrum-prescient :type git :flavor melpa :files ("selectrum-prescient.el" "selectrum-prescient-pkg.el") :host github :repo "raxod502/prescient.el") "consult" (consult :type git :flavor melpa :host github :repo "minad/consult") "consult-selectrum" nil "marginalia" (marginalia :type git :flavor melpa :host github :repo "minad/marginalia") "embark" (embark :type git :flavor melpa :files ("embark.el" "embark.texi" "embark-pkg.el") :host github :repo "oantolin/embark") "embark-consult" (embark-consult :type git :flavor melpa :files ("embark-consult.el" "embark-consult-pkg.el") :host github :repo "oantolin/embark") "avy" (avy :type git :flavor melpa :host github :repo "abo-abo/avy") "ace-window" (ace-window :type git :flavor melpa :host github :repo "abo-abo/ace-window") "shrink-whitespace" (shrink-whitespace :type git :flavor melpa :host gitlab :repo "jcpetkovich/shrink-whitespace.el") "company" (company :type git :flavor melpa :files (:defaults "icons" "company-pkg.el") :host github :repo "company-mode/company-mode") "expand-region" (expand-region :type git :flavor melpa :host github :repo "magnars/expand-region.el") "smex" (smex :type git :flavor melpa :host github :repo "nonsequitur/smex") "magit" (magit :type git :flavor melpa :files ("lisp/magit" "lisp/magit*.el" "lisp/git-rebase.el" "Documentation/magit.texi" "Documentation/AUTHORS.md" "LICENSE" (:exclude "lisp/magit-libgit.el" "lisp/magit-section.el") "magit-pkg.el") :host github :repo "magit/magit") "git-commit" (git-commit :type git :flavor melpa :files ("lisp/git-commit.el" "git-commit-pkg.el") :host github :repo "magit/magit") "transient" (transient :type git :flavor melpa :files ("lisp/*.el" "docs/transient.texi" "transient-pkg.el") :host github :repo "magit/transient") "with-editor" (with-editor :type git :flavor melpa :host github :repo "magit/with-editor") "magit-section" (magit-section :type git :flavor melpa :files ("lisp/magit-section.el" "Documentation/magit-section.texi" "magit-section-pkg.el") :host github :repo "magit/magit") "reveal-in-osx-finder" (reveal-in-osx-finder :type git :flavor melpa :host github :repo "kaz-yos/reveal-in-osx-finder") "multiple-cursors" (multiple-cursors :type git :flavor melpa :host github :repo "magnars/multiple-cursors.el") "hungry-delete" (hungry-delete :type git :flavor melpa :host github :repo "nflath/hungry-delete") "smartparens" (smartparens :type git :flavor melpa :host github :repo "Fuco1/smartparens") "aggressive-indent" (aggressive-indent :type git :flavor melpa :host github :repo "Malabarba/aggressive-indent-mode") "undo-tree" nil "evil-nerd-commenter" (evil-nerd-commenter :type git :flavor melpa :host github :repo "redguardtoo/evil-nerd-commenter") "which-key" (which-key :type git :flavor melpa :host github :repo "justbur/emacs-which-key") "windmove" nil "wgrep" (wgrep :type git :flavor melpa :files ("wgrep.el" "wgrep-pkg.el") :host github :repo "mhayashi1120/Emacs-wgrep") "yasnippet" (yasnippet :type git :flavor melpa :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet") "wc-mode" (wc-mode :type git :flavor melpa :host github :repo "bnbeckwith/wc-mode") "company-prescient" (company-prescient :type git :flavor melpa :files ("company-prescient.el" "company-prescient-pkg.el") :host github :repo "raxod502/prescient.el") "crux" (crux :type git :flavor melpa :host github :repo "bbatsov/crux") "fish-mode" (fish-mode :type git :flavor melpa :host github :repo "wwwjfy/emacs-fish") "olivetti" (olivetti :type git :flavor melpa :host github :repo "rnkn/olivetti") "dired+" nil "org-ref" (org-ref :type git :flavor melpa :files (:defaults "org-ref.org" "org-ref.bib" "citeproc" "org-ref-pkg.el") :host github :repo "jkitchin/org-ref") "htmlize" (htmlize :type git :flavor melpa :host github :repo "hniksic/emacs-htmlize") "helm" (helm :type git :flavor melpa :files ("*.el" "emacs-helm.sh" (:exclude "helm.el" "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core-pkg.el") "helm-pkg.el") :host github :repo "emacs-helm/helm") "async" (async :type git :flavor melpa :host github :repo "jwiegley/emacs-async") "popup" (popup :type git :flavor melpa :files ("popup.el" "popup-pkg.el") :host github :repo "auto-complete/popup-el") "helm-core" (helm-core :type git :flavor melpa :files ("helm-core-pkg.el" "helm.el" "helm-lib.el" "helm-source.el" "helm-multi-match.el" "helm-core-pkg.el") :host github :repo "emacs-helm/helm") "helm-bibtex" (helm-bibtex :type git :flavor melpa :files ("helm-bibtex.el" "helm-bibtex-pkg.el") :host github :repo "tmalsburg/helm-bibtex") "bibtex-completion" (bibtex-completion :type git :flavor melpa :files ("bibtex-completion.el" "bibtex-completion-pkg.el") :host github :repo "tmalsburg/helm-bibtex") "parsebib" (parsebib :type git :flavor melpa :host github :repo "joostkremers/parsebib") "s" (s :type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el") "f" (f :type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el") "biblio" (biblio :type git :flavor melpa :files (:defaults (:exclude "biblio-core.el") "biblio-pkg.el") :host github :repo "cpitclaudel/biblio.el") "biblio-core" (biblio-core :type git :flavor melpa :files ("biblio-core.el" "biblio-core-pkg.el") :host github :repo "cpitclaudel/biblio.el") "ivy" (ivy :type git :flavor melpa :files (:defaults (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "doc/ivy-help.org" "ivy-pkg.el") :host github :repo "abo-abo/swiper") "hydra" (hydra :type git :flavor melpa :files (:defaults (:exclude "lv.el") "hydra-pkg.el") :host github :repo "abo-abo/hydra") "lv" (lv :type git :flavor melpa :files ("lv.el" "lv-pkg.el") :host github :repo "abo-abo/hydra") "pdf-tools" (pdf-tools :type git :flavor melpa :files ("lisp/*.el" "README" ("build" "Makefile") ("build" "server") (:exclude "lisp/tablist.el" "lisp/tablist-filter.el") "pdf-tools-pkg.el") :host github :repo "vedang/pdf-tools") "tablist" (tablist :type git :flavor melpa :host github :repo "politza/tablist") "orgonomic" nil "org-journal" (org-journal :type git :flavor melpa :host github :repo "bastibe/org-journal") "deft" (deft :type git :flavor melpa :host github :repo "jrblevin/deft") "org-roam" (org-roam :type git :flavor melpa :host github :repo "org-roam/org-roam") "emacsql" (emacsql :type git :flavor melpa :files ("emacsql.el" "emacsql-compiler.el" "emacsql-system.el" "README.md" "emacsql-pkg.el") :host github :repo "skeeto/emacsql") "emacsql-sqlite" (emacsql-sqlite :type git :flavor melpa :files ("emacsql-sqlite.el" "sqlite" "emacsql-sqlite-pkg.el") :host github :repo "skeeto/emacsql") "markdown-mode" (markdown-mode :type git :flavor melpa :host github :repo "jrblevin/markdown-mode") "auctex" nil "auctex-latexmk" (auctex-latexmk :type git :flavor melpa :host github :repo "tom-tan/auctex-latexmk") "cdlatex" (cdlatex :type git :flavor melpa :host github :repo "cdominik/cdlatex") "bibtex-actions" (bibtex-actions :type git :flavor melpa :host github :repo "bdarcus/bibtex-actions") "ebib" (ebib :type git :flavor melpa :host github :repo "joostkremers/ebib") "web-mode" (web-mode :type git :flavor melpa :host github :repo "fxbois/web-mode") "emmet-mode" (emmet-mode :type git :flavor melpa :host github :repo "smihica/emmet-mode") "company-web" (company-web :type git :flavor melpa :host github :repo "osv/company-web") "web-completion-data" (web-completion-data :type git :flavor melpa :files ("*.el" "html-stuff" "web-completion-data-pkg.el") :host github :repo "osv/web-completion-data") "major-mode-hydra" (major-mode-hydra :type git :flavor melpa :files ("major-mode-hydra.el" "major-mode-hydra-pkg.el") :host github :repo "jerrypnz/major-mode-hydra.el") "pretty-hydra" (pretty-hydra :type git :flavor melpa :files ("pretty-hydra.el" "pretty-hydra-pkg.el") :host github :repo "jerrypnz/major-mode-hydra.el") "diminish" (diminish :type git :flavor melpa :host github :repo "myrjola/diminish.el") "ox-hugo" (ox-hugo :type git :flavor melpa :host github :repo "kaushalmodi/ox-hugo"))) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "let-alist" (let-alist :type git :host github :repo "emacs-straight/let-alist" :files ("*" (:exclude ".git"))) "seq" nil "consult-selectrum" nil "undo-tree" (undo-tree :type git :host github :repo "emacs-straight/undo-tree" :files ("*" (:exclude ".git"))) "windmove" nil "dired+" nil "orgonomic" nil "auctex" (auctex :type git :host github :repo "emacs-straight/auctex" :files ("*" (:exclude ".git"))))) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "seq" nil "consult-selectrum" nil "windmove" nil "dired+" nil "orgonomic" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "cl-lib" nil "seq" nil "consult-selectrum" nil "windmove" nil "dired+" (dired+ :type git :host github :repo "emacsmirror/dired-plus") "orgonomic" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "el-get" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "use-package-ensure-system-package" "system-packages" "use-package-chords" "bind-chord" "key-chord" "exec-path-from-shell" "cl-lib" "hc-zenburn-theme" "modus-themes" "general" "flycheck" "dash" "pkg-info" "epl" "let-alist" "seq" "selectrum" "prescient" "selectrum-prescient" "consult" "consult-selectrum" "marginalia" "embark" "embark-consult" "avy" "ace-window" "shrink-whitespace" "company" "expand-region" "smex" "magit" "git-commit" "transient" "with-editor" "magit-section" "reveal-in-osx-finder" "multiple-cursors" "hungry-delete" "smartparens" "aggressive-indent" "undo-tree" "evil-nerd-commenter" "which-key" "windmove" "wgrep" "yasnippet" "wc-mode" "company-prescient" "crux" "fish-mode" "olivetti" "dired+" "org" "org-contrib" "org-ref" "htmlize" "helm" "async" "popup" "helm-core" "helm-bibtex" "bibtex-completion" "parsebib" "s" "f" "biblio" "biblio-core" "ivy" "hydra" "lv" "pdf-tools" "tablist" "orgonomic" "deft" "org-roam" "emacsql" "emacsql-sqlite" "markdown-mode" "auctex" "auctex-latexmk" "cdlatex" "bibtex-actions" "ebib" "web-mode" "emmet-mode" "company-web" "web-completion-data" "ox-hugo" "major-mode-hydra" "pretty-hydra" "diminish")
