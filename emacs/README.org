...
View only the current day's agenda.
...
Auto refresh org agenda every minute, from [[https://emacs.stackexchange.com/questions/47254/update-the-org-agenda-daily-view-automatically-on-background][Stack Exchange]]
